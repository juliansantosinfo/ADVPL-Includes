	...
	#define STR0093 "Se selecciono la opcion REALIZAR TODAS modificaciones en el SXB y NO MOSTRAR mas la pantalla de aviso."
	#define STR0094 "Se selecciono la opcion NO REALIZAR ninguna modificacion en el SXB que este diferente a la base y NO MOSTRAR mas la pantalla de aviso."
	...
	#define STR0143 "Clave del indice modificado "
		...
		#define STR0115 If( cPaisLoc $ "ANG|PTG", "A actualizaro Helps de Campos ...", "Atualizando Helps de Campos ..." )
