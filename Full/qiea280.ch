	...
	#define STR0011 "Indice no registrado."
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "índice De Qualidade", "Indice de Qualidade" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Abandonar", "Abandona" )
		#define STR0008 "Confirma"
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Quanto à exclusão?", "Quanto à exclusäo?" )
		#define STR0010 "Indice näo é do tipo Informado."
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "índice não registado.", "Indice näo cadastrado." )
	#endif
#endif
