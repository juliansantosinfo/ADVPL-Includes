	...
	#else
		#define STR0001 "Integração de Rescisões"
		#define STR0002 "Este programa realizará a Integração das rescisões para o arquivo de    "
		#define STR0003 "movimento mensal, transferindo os dados e atualizando-os                "
		#define STR0004 "Confirma configuração dos parâmetros?"
		#define STR0005 "Fim do processo de Integração!"
		#define STR0006 "Atenção!"
		#define STR0007 "O roteiro selecionado não é de Rescisão!"
		#define STR0008 "O período selecionado ja foi integrado!"
		#define STR0009 'O "Alias" informado não existe!'
	#endif
#endif
