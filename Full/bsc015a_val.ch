	...
	#define STR0015 "Cuadrimestre"
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Folha De Cálculo De Resultado", "Planilha de Resultado" )
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "Folha De Cálculo De Referência", "Planilha de Referencia" )
