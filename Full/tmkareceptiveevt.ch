	...
	#define STR0003 "No fue posible completar la llamada pues el numero de telefono es invalido."
	...
	#define STR0016 "Tente nuevamente." + Chr(13)+Chr(10) + "Si el problema persiste, entre en contacto con el administrador del sistema y relate la situacion."
		...
		#define STR0003 "Unable to complete call as the telephone number is invalid."
		...
		#define STR0009 "Unable to complete call as the telephone number does not answer."
		#define STR0010 "Try again later."
		#define STR0011 "Unable to put call on hold as all positions are busy."
		#define STR0012 "Try again."
		#define STR0013 "Unable to complete call as call has been answered by a voice mail."
