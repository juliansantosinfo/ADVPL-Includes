	...
	#define STR0026 "    Atualização do Parametro: "
	#define STR0027 "Actualizando Parametros..."
	#define STR0028 "Verifique  o conteúdo dos parametros atualizados:"
	...
	#define STR0034 "Disparadores actualizados: "
		...
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "A actualizar Dicionario de Ficheiros...", "Atualizando Dicionario de Arquivos..." )
		...
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Foram incluídas as seguintes consultas padrões : ", "Foram incluídas as seguintes consultas padrão : " )
		...
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "A analisar gatilhos...", "Analisando Gatilhos..." )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "A actualizar gatilhos...", "Atualizando Gatilhos..." )
