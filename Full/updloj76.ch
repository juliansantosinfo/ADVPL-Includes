#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 00000029745/2010. "
	...
	#define STR0004 "FNC 00000029745/2010"
	...
	#define STR0012 "Inicio - Dicionario de Datos"
	...
	#define STR0029 "ok "
	#define STR0030 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 00000000513/2011."
	#define STR0031 "FNC 00000000513/2011"
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with FNC 00000029745/2010. "
		...
		#define STR0029 "ok "
		#define STR0030 "This program adjusts data dictionaries in accordance with FNC 00000000513/2011."
		#define STR0031 "FNC 00000000513/2011"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "O objectivo deste programa é ajustar os dicionários de dados em função da FNC 00000029745/2010. ", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 00000029745/2010. " )
		...
		#define STR0029 "ok "
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "O objectivo deste programa é ajustar os dicionários de dados em função da FNC 00000000513/2011.", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 00000000513/2011." )
		#define STR0031 "FNC 00000000513/2011"
	#endif
#endif
