	...
	#define STR0021 "Anadiendo indice numero 5 en la tabla AB6 e indice numero 6 en la tabla AB7"
		...
		#define STR0009 "Empresa : "
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "A criar campos da tabela SLR e SL2 no dicionário de dados", "Criando campos da tabela SLR e SL2 no dicionário de dados" )
		#define STR0011 "Criando gatilhos da tabela SLR no dicionário de dados"
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Log da actualização ", "Log da atualizacao " )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Actualização concluida com sucesso", "Atualizacao concluida com sucesso" )
		...
		#define STR0020 "Continuar"
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "A adicionar índice número 5 na tabela AB6 e índice número 6 na tabela AB7", "Adicionando índice número 5 na tabela AB6 e índice número 6 na tabela AB7" )
	#endif
#endif
