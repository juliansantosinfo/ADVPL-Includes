	...
	#define STR0007 "¡Regalo(s) incluido(s) con éxito!"
#else
	#ifdef ENGLISH
	...
	#else
		#define STR0001 "Beneficiarios Presentes na Campanha"
		#define STR0002 "Brindes na Campanha"
		#define STR0003 "Brindes da Campanha"
		#define STR0004 "Lista de Pacientes Presentes na Campanha"
		#define STR0005 "Gravar"
		#define STR0006 "Não existe nenhum Brinde Marcado"
