#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 516/2010 . "
	...
	#define STR0013 "Analizando Diccionario de Dadtos..."
	...
	#define STR0023 "Inicio - Apertura de Tablas"
	#define STR0024 "Final - Apertura de Tablas"
	...
	#define STR0029 "Ok"
	#define STR0030 "Calcula el ICMS de acuerdo con el ECF"
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts the data dictionaries due to FNC 516/2010. "
		...
		#define STR0029 "Ok"
		#define STR0030 "Calculate ICMS according to ECF"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa ajusta os diccionários de dados em função da FNC 516/2010 . ", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 516/2010 . " )
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Faça um backup dos diccionários e base de dados antes do proccessamento!", "Faça um backup dos dicionários e base de dados antes do processamento!" )
		#define STR0004 " FNC 516 / 2010 "
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Início Actualizar Estructuras ", "Inicio Atualizando Estruturas " )
		...
		#define STR0029 "Ok"
		#define STR0030 "Calcula o ICMS conforme o ECF"
	#endif
#endif
