#ifdef SPANISH
	#define STR0001 "Este programa tiene el objetivo de ajustar los diccionarios de datos en funcion de la FNC 00000023895/2010."
	...
	#define STR0004 "FNC 00000023895/2010"
	...
	#define STR0018 "Ocurrió un error desconocido durante la actualizacion de la tabla : "
	...
	#define STR0031 "Campo LQ_PROVENT registrado."
	#define STR0032 "Campo LR_PROVENT registrado."
	#define STR0033 "Campo L1_PROVENT registrado."
	#define STR0034 "Campo L2_PROVENT registrado."
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries due to FNC 00000023895/2010."
		...
		#define STR0031 "The field LQ_PROVENT is already registered."
		#define STR0032 "The field LR_PROVENT is already registered."
		#define STR0033 "The field L1_PROVENT is already registered."
		#define STR0034 "The field L2_PROVENT is already registered."
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função da FNC 00000023895/2010.", "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 00000023895/2010." )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Campo LQ_PROVENT já registado.", "Campo LQ_PROVENT já cadastrado." )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "Campo LR_PROVENT já registado.", "Campo LR_PROVENT já cadastrado." )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Campo L1_PROVENT já registado.", "Campo L1_PROVENT já cadastrado." )
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "Campo L2_PROVENT já registado.", "Campo L2_PROVENT já cadastrado." )
	#endif
#endif
