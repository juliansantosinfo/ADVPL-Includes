	...
	#define STR0019 "Inicio Actualizando Estructuras "
		...
		#define STR0009 "Empresa : "
		#define STR0010 "Continuar"
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "A criar campos da tabela acg e se1 no dicionário de dados", "Criando campos da tabela ACG e SE1 no dicionário de dados" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "A criar bases de dados da tabela acg no dicionário de dados", "Criando gatilhos da tabela ACG no dicionário de dados" )
