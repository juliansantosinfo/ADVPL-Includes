	...
	#define STR0024 " Se actualizo anteriormente en el SX2"
	#define STR0025 "Actualizacion de índices en el SIX"
	...
	#define STR0029 "Actual. de configuracion de uso de campos en el SX3"
	#define STR0030 " se modifico "
	#define STR0031 "No fue posible abrir el SIGAMNT.EMP en modo exclusivo"
	#define STR0032 "Verifique si existen usuarios en sistema."
	#define STR0033 "Actualizacion de Tablas:"
	...
	#define STR0037 "¡Archivo SIGAMAT.EMP no encontrado!"
		...
		#define STR0021 "*** Inconsistence *** Unable to create backup for the file "
		#define STR0022 "Updating file "
		#define STR0023 "File "
		#define STR0024 " It was previously updated in SX2"
		#define STR0025 "Index update in SIX"
		#define STR0026 " It was previously updated in"
		#define STR0027 "Field update in SX3"
		#define STR0028 "*** Inconsistence *** Unable to create the new file"
		#define STR0029 "Configuration update of fields use in SX3"
		#define STR0030 " was edited"
		#define STR0031 "Unable to open SIGAMNT.EMP in exclusive mode"
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "  este programa tem como objectivo a compatibilização   dos dicionários de dados ", "  Este programa tem como objetivo a compatibilização dos dicionários de dados " )
		...
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "Não foi possivel abrir sigamat.emp", "Não foi possível abrir SIGAMAT.EMP" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Operação cancelada pelo utilizador", "Operação cancelada pelo usuário" )
		...
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "*** inconsistência *** não foi possível criar a salva-guarda do ficheiro ", "*** Incosistência *** Não foi possível criar o backup do arquivo " )
		...
		#define STR0025 If( cPaisLoc $ "ANG|PTG", "Actualização de indices no six", "Atualização de índices no SIX" )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Não foi possível abrir o sigamnt.emp em modo exclusivo", "Não foi possível abrir o SIGAMNT.EMP em modo exclusivo" )
