	...
	#define STR0029 "Ok "
		...
		#define STR0029 "OK "
	#else
		#define STR0001 "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 164502009. "
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Operação anulada!", "Operaçao cancelada!" )
		...
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Atualização Concluída.", "Atualizacao Concluída." )
