	...
	#define STR0015 "Descuento por Rango de Produccion"
	...
	#define STR0045 "¿Rellenar tabla BLR - Rangos de Edad Plan Familiar?"
	#define STR0046 "Rellenando tabla de Tipo de Registro..."
	#define STR0047 "Realizada carga de datos en la tabla BLR - Rangos de Edad Plan Familiar."
	#define STR0048 "¿Desc. Prod?"
	#define STR0049 "¿Descuento por Produccion?   "
	#define STR0050 "Informar si se debe considerar el Descuento por Produccion."
	#define STR0051 "Produccion                  "
	#define STR0052 "Debitos mensuales fijos            "
	#define STR0053 "Creditos mensuales fijos           "
	#define STR0054 "Creditos variables               "
	#define STR0055 "Debitos variables                "
	#define STR0056 "Apuntamientos Produccion            "
	#define STR0057 "Intervalo de Descuento"
	#define STR0058 "Sal Contrib INSS Otr Empresas    "
	#define STR0059 "Prov INSS PJ                     "
	#define STR0060 "Prov INSS PF                     "
	#define STR0061 "Cred Prov INSS                   "
	#define STR0062 "Valor Base INSS                  "
	#define STR0063 "Valor INSS                       "
	#define STR0064 "Valor Base ISS                   "
	#define STR0065 "Valor ISS                        "
	#define STR0066 "Valor Base PIS                   "
	#define STR0067 "Valor PIS                        "
	#define STR0068 "Valor Base COFINS                "
	#define STR0069 "Valor COFINS                     "
	#define STR0070 "Valor Base CSLL                  "
	#define STR0071 "Valor CSLL                       "
	#define STR0072 "Valor Base INSS PF               "
	#define STR0073 "Valor INSS PF                    "
	#define STR0074 "Valor Base INSS PJ               "
	#define STR0075 "Valor INSS PJ                    "
	#define STR0076 "Valor Base INSS PJ Filantropicas "
	#define STR0077 "Valor INSS PJ Filantropicas      "
	#define STR0078 "Valor Base de Impuesto de Renta      "
	#define STR0079 "Impuesto de Renta                 "
	#define STR0080 "Espere"
	#define STR0081 "Rellenando tabla... "
#else
	#ifdef ENGLISH
		...
		#define STR0015 "Discount by Production Range"
		...
		#define STR0045 "Populate table BLR - Family Plan Age Ranges?"
		#define STR0046 "Populating table Entry Type..."
		#define STR0047 "Load data in table BLR - Family Plan Age Ranges."
		#define STR0048 "Prod. Disc.?"
		#define STR0049 "Discount by Production?   "
		#define STR0050 "Enter whether or not to consider Discount by Production."
		#define STR0051 "Production                  "
		#define STR0052 "Monthly fixed debits            "
		#define STR0053 "Monthly fixed credits           "
		#define STR0054 "Variable credits               "
		#define STR0055 "Variable debits                "
		#define STR0056 "Production Annotations            "
		#define STR0057 "Discount Range "
		#define STR0058 "Sal INSS Contrib Oth Companies    "
		#define STR0059 "INSS Prov LE                     "
		#define STR0060 "INSS Prov NP                     "
		#define STR0061 "INSS Prov Cred                   "
		#define STR0062 "INSS Base Value                  "
		#define STR0063 "INSS Value                       "
		#define STR0064 "ISS Base Value                   "
		#define STR0065 "ISS Value                        "
		#define STR0066 "PIS Base Value                   "
		#define STR0067 "PIS Value                        "
		#define STR0068 "COFINS Base Value                "
		#define STR0069 "COFINS Value                     "
		#define STR0070 "CSLL Base Value                  "
		#define STR0071 "CSLL Value                       "
		#define STR0072 "INSS Base Value NP               "
		#define STR0073 "INSS Value NP                    "
		#define STR0074 "INSS Base Value LE               "
		#define STR0075 "INSS Value LE                    "
		#define STR0076 "INSS Base Value LE Charitable "
		#define STR0077 "INSS Value LE Charitable      "
		#define STR0078 "Base Value of Income Tax      "
		#define STR0079 "Income Tax                 "
		#define STR0080 "Please, wait..."
		#define STR0081 "Populating table... "
	#else
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Desconto por Faixa de Produção", "Desconto por Faixa de Producao" )
		...
		#define STR0044 "Marca/Desmarca"
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "Popular tabela BLR - Faixas Etárias Plano Familiar?", "Popular tabela BLR - Faixas Etarias Plano Familiar?" )
		#define STR0046 If( cPaisLoc $ "ANG|PTG", "A preencher tabela de Tipo de Lançamento...", "Populando tabela de Tipo de Lançamento..." )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", "Realizada carga de dados na tabela BLR - Faixas Etárias Plano Familiar.", "Realizada carga de dados na tabela BLR - Faixas Etarias Plano Familiar." )
		#define STR0048 "Desc. Prod?"
		#define STR0049 If( cPaisLoc $ "ANG|PTG", "Desconto por Produção?   ", "Desconto por Producao?   " )
		#define STR0050 "Informar se deve considerar o Desconto por Produção."
		#define STR0051 If( cPaisLoc $ "ANG|PTG", "Produção                  ", "Producao                  " )
		#define STR0052 If( cPaisLoc $ "ANG|PTG", "Débitos mensais fixos            ", "Debitos mensais fixos            " )
		#define STR0053 If( cPaisLoc $ "ANG|PTG", "Créditos mensais fixos           ", "Creditos mensais fixos           " )
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Créditos variáveis               ", "Creditos variaveis               " )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", "Débitos variáveis                ", "Debitos variaveis                " )
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "Apontamentos Produção            ", "Apontamentos Producao            " )
		#define STR0057 "Faixa de Desconto "
		#define STR0058 If( cPaisLoc $ "ANG|PTG", "Sal.Contrib.INSS Out Empresas    ", "Sal Contrib INSS Out Empresas    " )
		#define STR0059 If( cPaisLoc $ "ANG|PTG", "Prov.INSS PC                     ", "Prov INSS PJ                     " )
		#define STR0060 If( cPaisLoc $ "ANG|PTG", "Prov.INSS PS                     ", "Prov INSS PF                     " )
		#define STR0061 If( cPaisLoc $ "ANG|PTG", "Créd.Prov.INSS                   ", "Cred Prov INSS                   " )
		#define STR0062 "Valor Base INSS                  "
		#define STR0063 "Valor INSS                       "
		#define STR0064 "Valor Base ISS                   "
		#define STR0065 "Valor ISS                        "
		...
		#define STR0070 "Valor Base CSLL                  "
		#define STR0071 "Valor CSLL                       "
		#define STR0072 If( cPaisLoc $ "ANG|PTG", "Valor Base INSS PS               ", "Valor Base INSS PF               " )
		#define STR0073 If( cPaisLoc $ "ANG|PTG", "Valor INSS PS                    ", "Valor INSS PF                    " )
		#define STR0074 If( cPaisLoc $ "ANG|PTG", "Valor Base INSS PC               ", "Valor Base INSS PJ               " )
		#define STR0075 If( cPaisLoc $ "ANG|PTG", "Valor INSS PC                    ", "Valor INSS PJ                    " )
		#define STR0076 If( cPaisLoc $ "ANG|PTG", "Valor Base INSS PC Filantrópicas ", "Valor Base INSS PJ Filantropicas " )
		#define STR0077 If( cPaisLoc $ "ANG|PTG", "Valor INSS PC Filantrópicas      ", "Valor INSS PJ Filantropicas      " )
		#define STR0078 "Valor Base Imposto de Renda      "
		#define STR0079 "Imposto de Renda                 "
		#define STR0080 "Aguarde"
		#define STR0081 If( cPaisLoc $ "ANG|PTG", "A preencher tabela... ", "Populando tabela... " )
	#endif
#endif
