	...
	#define STR0032 "SALDO ACT. "
		...
		#define STR0029 If( cPaisLoc $ "ANG|EQU|HAI", "DÉBITO", If( cPaisLoc == "MEX", "Cartão Débito", If( cPaisLoc == "PTG", "Débito", "DEBITO" ) ) )
		#define STR0030 If( cPaisLoc $ "ANG|EQU|HAI", "CRÉDITO", If( cPaisLoc == "MEX", "Não é possivel gerar uma Nota de Crédito com o valor restante", If( cPaisLoc == "PTG", "Crédito", "CREDITO" ) ) )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Mov. Período", "Mov. Periodo" )
