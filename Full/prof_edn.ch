	...
	#define STR0016 "Retifica data da substitutiva "
	#define STR0017 "N/C ?"
	#define STR0018 "Descrição do Motivo da Alteração"
	#define STR0019 "confirmar"
	#define STR0020 "sair sem salvar"
	#define STR0021 "¿Confirma modificacion?"
	...
	#define STR0030 " punto."
		...
		#define STR0004 "Teacher without an e-mail registered !"
		...
		#define STR0016 "Rectifies date of substitutive test "
		#define STR0017 "N/C ?"
		#define STR0018 "Description of Change Reason"
		#define STR0019 "confirm"
		#define STR0020 "exit without saving"
		#define STR0021 "Confirm changes?   "
		#define STR0022 "Reason"
		#define STR0023 "Not correctly filled out   "
		...
		#define STR0016 If( cPaisLoc $ "ANG|PTG", "Rectifica data da substitutiva ", "Retifica data da substitutiva " )
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "N/c ?", "N/C ?" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Descrição Do Motivo Da Alteração", "Descrição do Motivo da Alteração" )
