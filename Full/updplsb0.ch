	...
	#define STR0002 "Esta rutina tiene la funcion de implementar la rutina Protocolo de reembolso, con el objetivo "
	#define STR0003 "de permitir un mayor control y trazabilidad a los procesos de reembolso de "
	#define STR0004 "una operadora de plan de salud. Se recomienda estrictamente que se haga un"
	...
	#define STR0058 "Se modificio clave unica de la tabla "
	...
	#define STR0139 "requisito 001473"
#else
	#ifdef ENGLISH
		#define STR0001 "TABLE AND DICTIONARY UPDATE"
		#define STR0002 "The purpose of this routine is to implement the Reimbursement Protocol routine, aiming to "
		#define STR0003 "allow greater control and traceability of reimbursement processes of "
		#define STR0004 "a health care cooperative. You must make"
		...
		#define STR0134 "Question changed. Group/Order "
		#define STR0135 "Updating Question Helps..."
		#define STR0137 "Field Helps"
		#define STR0138 "Question Helps"
		#define STR0139 "Requisition 001473"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "ACTUALIZAÇÃO DE DICIONÁRIOS E TABELAS", "ATUALIZAÇÃO DE DICIONÁRIOS E TABELAS" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Este procedimento tem como função implementadar o procedimento Protocolo de Reembolso, com o objectivo ", "Esta rotina tem como função implementadar rotina Protocolo de Reembolso, com o objetivo " )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "de permitir um maior controlo e rastreabilidade aos processos de reembolso de ", "de permitir um maior controle e rastreabilidade aos processos de reembolso de " )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "uma operadora de plano de saúde. É extremamente recomendavél que se faça um", "uma operadora de plano de saúde. É extremamente recomendavél  que  se  faça um" )
		...
		#define STR0098 If( cPaisLoc $ "ANG|PTG", "A actualizar ficheiros (SXA)...", "Atualizando Arquivos (SXA)..." )
