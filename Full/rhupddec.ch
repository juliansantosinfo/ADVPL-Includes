	...
	#define STR0035 "Actualizando Consultas Estandares..."
	#define STR0036 "Actualizando Tablas..."
		...
		#define STR0007 "This routine will update dictionary of data"
		#define STR0008 "."
		#define STR0009 "."
		#define STR0010 "There must not be users using the system during update!"
		#define STR0011 "Attention !"
		#define STR0012 "Updating Data v. "
		#define STR0013 "OK"
		...
		#define STR0033 "Updating Dictionary of Files..."
		#define STR0034 "Analyzing Standard Queries..."
		#define STR0035 "Updating Standard Queries..."
		...
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "A Analisar Consultas Padrões...", "Analisando Consultas Padroes..." )
		#define STR0035 If( cPaisLoc $ "ANG|PTG", "A Actualizar As Consultas Padrão...", "Atualizando Consultas Padroes..." )
