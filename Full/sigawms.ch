	...
	#define STR0014 "Todos los items estan borrados"
		...
		#define STR0010 "Cuts are allowed only in s.o.wms of dispatch and packing because it is a manual process and will considered by checking (wmsa360)"
		#define STR0011 "Enter warehouse"
		#define STR0012 "Product not found in the separation map"
