	...
	#define STR0025 "¿Desea generar Log?"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo De Horários", "Cadastro de Horários" )
		#define STR0002 "Pesquisar"
		#define STR0003 "Visualizar"
		#define STR0004 "Incluir"
		#define STR0005 "Alterar"
		#define STR0006 "Excluir"
		#define STR0007 "Horários"
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Diário De Inconsistencia Na Exclusão De Horários", "Log de Inconsistencia na Exclusao de Horarios" )
