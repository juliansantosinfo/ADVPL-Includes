	...
	#define STR0034 "No existe base para consultar"
	...
	#define STR0057 "Diente/Región posee. "
	#define STR0058 " "
	#define STR0059 "Informe el numeral que correspondera al "
	#define STR0060 "periodo de busqueda al historico del "
	#define STR0061 " "
	#define STR0062 "Caras ya restauradas."
	...
	#define STR0068 "Informa la cantidad de caras "
	...
	#define STR0072 "Alias - "
		...
		#define STR0054 ""
		#define STR0055 'Number of Surfaces'
		#define STR0056 "Enter the number of surfaces that "
		...
		#define STR0061 ""
		#define STR0062 "Surfaces already restored."
		#define STR0063 'Unit'
		...
		#define STR0068 "Enter the number of surfaces "
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Regras de quantidade", "Regras de Quantidade" )
		...
		#define STR0035 If( cPaisLoc $ "ANG|PTG", "Grupo emp", "Grupo Emp" )
		...
		#define STR0041 "Recno"
		#define STR0042 "Marca/Desmarca"
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "SX3 - Dicionário de campos", "SX3 - Dicionário de Campos" )
		...
		#define STR0046 If( cPaisLoc $ "ANG|PTG", "Estão a ser criados/alterados os seguintes campos: ", "Sendo criados/alterados os seguintes campos: " )
		...
		#define STR0049 If( cPaisLoc $ "ANG|PTG", " ", "" )
		...
		#define STR0054 If( cPaisLoc $ "ANG|PTG", " ", "" )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", 'Quantidade de faces', 'Quantidade de Faces' )
