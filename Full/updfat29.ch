	...
	#define STR0004 "usuarios o jobs utilizando el sistema. "
	#define STR0005 "Esta actualizacion corresponde a ajuste de los diccionarios para uso "
	#define STR0006 "de la rutina de Control de Reservas con componentes MVC."
	...
	#define STR0138 "VD=Vendedor;CL=Cliente;PD=Pedido;LB=Liberacion;NF=Factura;LJ=Sigaloja"
	#define STR0139 "Documento Responsable"
#else
	#ifdef ENGLISH
		...
		#define STR0004 "users or jobs using the system cannot exist. "
		#define STR0005 "This update corresponds to the dictionary adjustment to use "
		#define STR0006 "the routine of Reservation Control with MVC components."
		...
		#define STR0138 "VD=Sales Representative;CL=Customer;PD=Order;LB=Approval;NF=Invoice;LJ=Sigaloja"
		#define STR0139 "Responsible Document"
	#else
		...
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "utilizadores ou jobs usando o sistema. ", "usuários  ou  jobs utilizando  o sistema. " )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Esta actualização corresponde ao ajuste dos dicionários para uso ", "Esta atualização corresponde a ajuste dos dicionários para uso " )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "do procedimento de Controlo de Reservas com componentes MVC.", "da rotina de Controle de Reservas com componentes MVC." )
		...
		#define STR0058 If( cPaisLoc $ "ANG|PTG", "Foi alterada a chave única da tabela ", "Foi alterada chave unica da tabela " )
		...
		#define STR0138 If( cPaisLoc $ "ANG|PTG", "VD=Vendedor;CL=Cliente;PD=Pedido;LB=Liberação;NF=Factura;LJ=Sigaloja", "VD=Vendedor;CL=Cliente;PD=Pedido;LB=Liberacao;NF=Nota Fiscal;LJ=Sigaloja" )
		#define STR0139 If( cPaisLoc $ "ANG|PTG", "Documento responsável", "Documento Responsável" )
	#endif
#endif
