#ifdef SPANISH
	#define STR0001 "Responsables por Cliente"
...
#else
	#ifdef ENGLISH
		#define STR0001 "Responsible for Customer"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Responsáveis por cliente", "Responsáveis por Cliente" )
