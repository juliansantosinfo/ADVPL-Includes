	...
	#define STR0002 "Este Lote já foi confirmado !"
	#define STR0003 "Erro na recepção dos parâmetros"
	#define STR0004 "Confirmação de Inclusão de Notas"
	#define STR0005 "Dados atualizados com sucesso!!!"
	#define STR0006 "Por favor, aguarde de 5 a 10 minutos para novas alterações ou inclusões"
	#define STR0007 "AVISO ! Este Lote já foi Confirmado [ NOTAS ]"
	#define STR0008 "Lote não encontrado [ NOTAS ]"
	#define STR0009 "Lote Não Confirmado/Encontrado [ NOTAS ]"
	#define STR0010 "Exclusão efetuada com sucesso !"
	#define STR0011 "Lote já confirmado, não pode ser excluído !"
	#define STR0012 "Erro de Execução [ EXCLUSÃO DE LOTE NOTAS ]"
	#define STR0013 "Confirmação de Inclusão de Faltas"
	#define STR0014 "AVISO ! Este Lote já foi Confirmado [ FALTAS ]"
	#define STR0015 "Lote não encontrado [ FALTAS ]"
	#define STR0016 "Erro de Execução [ EXCLUSÃO DO LOTE ]"
	#define STR0017 "Procedimento de Confirmação"
