	...
	#define STR0009 "A traves del menu al lado, Ud. podra realizar diversas operaciones que lo auxiliaran en la gestion de su equipo (líderes) y de su vida profesional en Microsiga. (lea en los items abajo, mas detalles sobre objetivos y usos de cada  componente del modelo)."
	...
	#define STR0011 "Líderes y sus participantes deben mantener en mente los seguientes resultados calficativos esperados com este modelo y portal:"
	...
	#define STR0015 "- claridad en los procesos, reglas y critérios de reconocimiento profesional;"
	#define STR0016 "- consistencia en las decisiciones de reconocimiento: informaciones completas/claras para fundamentar decisiones justas de aumentos salariales por mérito y/o promociones;"
	...
	#define STR0019 "- atraer, desarrollar, reconocer y retener nuestros participantes."
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Currículo eletrónico", "Currículo Eletrônico" )
		...
		#define STR0008 "Bem-vindo ao portal de gestão de performance, feedback e desenvolvimento pessoal da Microsiga. Este nosso portal proporcia a líderes e participantes da Microsiga um ambiente e ferramentas para a gestão de nosso capital humano: planejando, auxiliando e acompanhando o desempenho e o crescimento profissional."
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Por meio do menu ao lado, voce poderá realizar diversas operações que o auxiliarao na gestão de sua equipe (lideres) e de sua vida profissional na microsiga. (leia nos itens abaixo mais detalhes sobre objetivos e usos de cada  componente do modelo).", "Por meio do menu ao lado, você poderá realizar diversas operações que o auxiliarão na gestão de sua equipe (líderes) e de sua vida profissional na Microsiga. (leia nos itens abaixo mais detalhes sobre objetivos e usos de cada  componente do modelo)." )
		#define STR0010 "Colocando-se em prática este nosso novo modelo de gestão do capital humano da Microsiga, sem dúvida teremos uma melhoria constante da comunicação e relacionamento entre líderes e equipes. Com a implementação e uso deste modelo e portal, bem como do treinamento contínuo de nossos líderes e equipes, esperamos rapidamente criar na Microsiga uma cultura que valorize fortemente o feedback, o crescimento pessoal e o reconhecimento da contribuição e desempenho de cada um."
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Lideres e seus participantes devem manter em mente os seguintes resultados qualitativos esperados com este modelo e portal:", "Líderes e seus participantes devem manter em mente os seguintes resultados qualitativos esperados com este modelo e portal:" )
		#define STR0012 "- alinhamento de expectativas em relação ao trabalho, desempenho esperado e progressão de carreira;"
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "- comprometimento e suporte mutuos para a superação de dificuldades ou para planos futuros de desenvolvimento profissional;", "- comprometimento e suporte mútuos para a superação de dificuldades ou para planos futuros de desenvolvimento profissional;" )
		#define STR0014 "- reconhecer e remunerar por meritocracia (merecimento): performance, conhecimento, atingimento de metas e contribuições;"
		#define STR0015 "- clareza nos processos, regras e critérios de reconhecimento profissional;"
		#define STR0016 If( cPaisLoc $ "ANG|PTG", "- consistência nas decisões de reconhecimento: informações completas/claras para servirem de base a decisões justas de aumentos salariais por mérito e/ou promoções;", "- consistência nas decisões de reconhecimento: informações completas/claras para embasar decisões justas de aumentos salariais por mérito e/ou promoções;" )
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "- gestão eficaz dos nossos processos de alocação de recursos em projectos, transferências internas, recrutamento e formação;", "- gestão eficaz de nossos processos de alocação de recursos em projetos, transferências internas, recrutamento e treinamento;" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "- impulsionar o sucesso do nosso negócio através da satisfação pessoal e motivação dos colaboradores;", "- alavancar o sucesso do nosso negócio através da satisfação pessoal e motivação dos participantes;" )
