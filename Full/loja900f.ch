	...
	#define STR0007 "¡Error al consumir el metodo TabelaPrecoVariante del WebService!"
	#define STR0008 "Error en el metodo XmlParser: "
#else
	#ifdef ENGLISH
		...
		#define STR0007 "Error when consuming WebService TabelaPrecoVariante!"
		...
		#define STR0007 "Erro ao consumir o método TabelaPrecoVariante do WebService!"
