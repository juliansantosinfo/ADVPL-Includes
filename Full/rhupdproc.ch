	...
	#define STR0032 "Indices actualizados : "
		...
		#define STR0008 "."
		#define STR0009 "."
		#define STR0010 If( cPaisLoc $ "ANG|PTG", " não devem existir utilizadores a utilizar o sistema durante a actualização !", " Nao devem existir usuarios utilizando o sistema durante a atualizacao !" )
