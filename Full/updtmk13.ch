	...
	#define STR0010 "Creando campos de la tabla SUQ y SUD en el diccionario de datos"
	#define STR0011 "Creando Disparadores de la Tabla SUD en el diccionario de datos"
	...
	#define STR0020 "Continuar"
		...
		#define STR0010 "Creating fields of SUQ and SUD tables in data dictionary"
		#define STR0011 "Creating triggers of table SUD in data dictionary"
		...
		#define STR0009 "Empresa : "
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "A criar campos da tabela SUQ e SUD no dicionário de dados", "Criando campos da tabela SUQ e SUD no dicionário de dados" )
