#ifdef SPANISH
	#define STR0001 "Update UPDPCP20"
	#define STR0002 "Creacion de los campos C4_MOPC y HC_MOPC"
	#define STR0003 "Procesamiento del ajuste de cada tabla:"
	#define STR0004 "¡Atencion: para que el ajuste poueda realizarse NINGUN usuario puede estar utilizando el sistema!"
	#define STR0005 "La rutina de actualizacion creara los campos necesarios para la utilizacion de las nuevas funcionalidades en las rutinas Prevision de ventas y Plan maestro de produccion"
	#define STR0006 "Antes de que se inicie la actualizacion, debe leerse y aceptarse los terminos y las condiciones a continuacion. Tras aceptarlos, se podra proseguir con la actualizacion."
	#define STR0007 "AVISO:"
	#define STR0008 "Este compatibilizador procesara actualizaciones en los diccionarios de datos de las empresas selecionadas adicionando campos a las tablas SC4 y SHC."
	#define STR0009 "IMPORTANTE: El funcionamiento de la integracion dependera, ademas del procesamiento de este update, de la configuracion del paramentro MV_REPGOPC. Mas detalles disponibles en el boletin que acompana este update."
	#define STR0010 "OBSERVACION: La actualizacion se procesara de manera que no impacte en las funcionalidades ya existentes en el sistema."
	#define STR0011 "Libre"
	#define STR0012 "¡SIGAMAT.EMP con problemas!"
	#define STR0013 "SIGAPCP - Update"
	#define STR0014 "&Calcular"
	...
	#define STR0047 "La extencion '.LOG' se adiciono al archivo, que se grabo del directorio seleccionado ("
	...
	#define STR0055 "Se crearon nuevos campos para las tablas: "
#else
	#ifdef ENGLISH
		#define STR0001 "Update UPDPCP20"
		#define STR0002 "Creation of fields C4_MOPC and HC_MOPC"
		...
		#define STR0005 "The update routine creates fields required for the use of new functionalities in Sales Forecast and Production Master Plan routines."
		...
		#define STR0008 "This compatibility program processes updates in data dictionaries of companies selected adding fields to SC4 and SHC tables."
		#define STR0009 "IMPORTANT: Integration depends on the configuration of MV_REPGOPC parameter besides the processing of this update. Further details are available in the newsletter that comes with this update."
	...
	#else
		#define STR0001 "Update UPDPCP20"
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Criação dos campos C4_MOPC e HC_MOPC", "Criacao dos campos C4_MOPC e HC_MOPC" )
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "O procedimento de actualização criará os campos necessários para a utilização das novas funcionalidades nos procedimentos Previsão de vendas e Plano mestre de produção", "A rotina de atualização irá criar os campos necessários para a utilização das novas funcionalidades nas rotinas Previsão de Vendas e Plano Mestre de Produção" )
