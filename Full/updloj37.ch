#ifdef SPANISH
	#define STR0001 "Este programa tiene el objetivo de ajustar los diccionarios de datos en funcion de la FNC 162052009. "
	#define STR0002 "¡Esta rutina se debe utilizar de modo exclusivo! "
	#define STR0003 "¡Haga un backup de los diccionarios y de la base de datos antes del procesamiento!"
	#define STR0004 "FNC 162052009"
	...
	#define STR0029 "Ok "
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with FNC 162052009. "
		...
		#define STR0019 ". Check table and dictionary integrity."
		...
		#define STR0028 "Company table cannot be opened in exclusive mode!"
		#define STR0029 "OK "
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 162052009. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 162052009. " )
