	...
	#define STR0006 "Actualizacion del Diccionario de Datos -> UPDMNT17"
	...
	#define STR0009 "  y crea los campos que vinculan los memos de la TRX con la tabla SYP. "
	#define STR0010 "  Para hacer la actualizacion, sera necesario el acceso exclusivo a los archivos,  "
	#define STR0011 "  que no pueden estar en uso en otras estaciones."
	#define STR0012 "Actualizacion del Diccionario -> UPDMNT17"
	...
	#define STR0026 " tuvo su clave unica modificada en SX2"
	#define STR0027 "Actualizacion de indices en SINDEX "
	#define STR0028 " ya se actualizo anteriormente "
	#define STR0029 "Actualizacion de campos en SX3"
	#define STR0030 "Actualizacion de la configuracion de uso de campos en SX3"
	#define STR0031 " se modifico"
	#define STR0032 "Actualizacion de la configuracion de validacion de campos en SX3"
	...
	#define STR0050 "Favor actualizar la tabla manualmente."
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Actualização do Dicionário de Dados -> UPDMNT17", "Atualização do Dicionário de Dados -> UPDMNT17" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Actualização de registos", "Atualização Arquivos" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "  Este programa faz a actualização dos dicionários de dados,   ", "  Este programa tem como objetivo fazer a atualização dos dicionários de dados,  " )
		#define STR0009 "  criando os campos que fazem a ligação dos memos da TRX com a tabela SYP. "
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "  Para a actualização, será necessário o acesso exclusivo aos registos, e não ", "  Para a atualização será necessário acesso exclusivo aos arquivos, não " )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "  pode ser utilizado por outras estações.", "  podendo estar em uso por outras estações." )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Actualização do Dicionário -> UPDMNT17", "Atualização do Dicionário -> UPDMNT17" )
		...
		#define STR0036 " não possui Gestão de Frotas!"
		#define STR0037 If( cPaisLoc $ "ANG|PTG", "Não foi possível abrir Sigamat.Emp.", "Nao foi possivel Abrir Sigamat.Emp" )
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "Aviso!", "Aviso!!!" )
