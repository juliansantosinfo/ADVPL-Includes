#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion del BOPS 153542. "
	...
	#define STR0029 "Ok"
	#define STR0030 "Indica si utiliza el metodo de conexion "
	#define STR0031 "con el RPC FwRPC del Framework de TOTVS."
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with BOPS 2581/2009. "
		...
		#define STR0021 "An unknown error occurred during the table structure update: "
		...
		#define STR0029 "OK"
		#define STR0030 "Indicate use of connection method"
		#define STR0031 "with RPC FwRPC of TOTVS Framework."
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função do BOPS 153542. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 153542. " )
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Inicio A actualizar Estruturas ", "Inicio Atualizando Estruturas " )
		...
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Inicio - A abrir Tabelas", "Inicio - Abrindo Tabelas" )
		...
		#define STR0029 "Ok"
		#define STR0030 "Indica se utiliza o método de conexão"
		#define STR0031 "com o RPC FwRPC do Framework da TOTVS."
	#endif
#endif
