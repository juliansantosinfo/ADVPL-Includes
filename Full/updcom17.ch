#ifdef SPANISH
	#define STR0001 "Update UPDCOM17"
	...
	#define STR0024 "¡No se pudo abrir la tabla de empresas de forma exclusiva!"
	#define STR0025 "Valor Peaje"
#else
	#ifdef ENGLISH
		#define STR0001 "Update UPDCOM17"
		#define STR0002 "Do you want to update Dictionary? This routine must be used in exclusive mode! Make a backup of dictionaries and database before update in case of update failures!"
		...
		#define STR0025 "Toll Value"
	#else
		#define STR0001 "Update UPDCOM17"
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Deseja efectuar a actualização do Dicionário? Este procedimento deve ser utilizado em modo exclusivo. Faça um backup dos dicionários e da Base de Dados antes da actualização para eventuais falhas de actualização.", "Deseja efetuar a atualizacao do Dicionário? Esta rotina deve ser utilizada em modo exclusivo ! Faca um backup dos dicionários e da Base de Dados antes da atualização para eventuais falhas de atualização !" )
