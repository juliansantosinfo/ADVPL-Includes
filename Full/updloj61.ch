#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 00000017415/2010. "
	...
	#define STR0004 "FNC 00000017415/2010"
	...
	#define STR0029 "ok "
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries due to FNC 00000017415/2010. "
		...
		#define STR0029 "ok "
	#else
		#define STR0001 "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 00000017415/2010. "
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "registos Texto (*.TXT) |*.txt|", "Arquivos Texto (*.TXT) |*.txt|" )
		...
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Nao foi possivel a abertura da tabela de empresas de forma exclusiva!", "Nao foi possivel a abertura da tabela de empresas de forma exclusiva !" )
