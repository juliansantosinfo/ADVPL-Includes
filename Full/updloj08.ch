#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion del BOPS 134504. "
	...
	#define STR0029 "Ok"
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with BOPS 134504. "
		...
		#define STR0029 "OK"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função do BOPS 134504. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 134504. " )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Este processo deve ser processado em modo exclusivo! ", "Esta rotina deve ser processada em modo exclusivo! " )
