#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 238862009. "
	...
	#define STR0029 "ok "
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with FNC 238862009. "
		...
		#define STR0029 "ok "
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa ajusta os diccionários de dados em função do FNC 238862009. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 238862009. " )
		...
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Fim- Actualizar Estructuras ", "Fim Atualizando Estruturas " )
