	...
	#define STR0004 "DETALLE DEL SALDO DE LA CUENTA "
	...
	#define STR0014 "Creando archivo temporario..."
		...
		#define STR0004 "DETAIL OF ACCOUNT BALANCE  "
		...
		#define STR0010 "leave parameter Ignore Prev. Bal. Date of  of Income/Expense = No "
		#define STR0011 "Ignore Previ. Bal. Date of  of Income/Expense"
		#define STR0012 " TO "
		#define STR0013 " IN "
		...
		#define STR0002 "conta é impressa limitando a 20 caracteres e sua descrição está limitada a 30 caracteres."
		#define STR0003 "Balancete de Inventário"
		#define STR0004 "DETALHE DO SALDO DA CONTA "
