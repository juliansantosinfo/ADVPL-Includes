	...
	#define STR0048 "Verifique si todos los campos del archivo XML están en conformidad con el layout definido."
	...
	#define STR0058 "Archivo tiene "
	...
	#else
		#define STR0001 "Reprocessamento de Lançamentos"
		#define STR0002 "Pesquisar"
		#define STR0003 "Reprocessar"
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Apagar lançamentos do período ?", "Apagar lançamentos do periodo ?" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Período de", "Periodo de" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Período Até", "Periodo Ate" )
		#define STR0007 "Filtro "
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Agrupar pelas Ent. Orçamentárias ?", "Agrupar pelas Ent. Orcamentárias ?" )
		...
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "A excluir lançamentos...", "Excluindo lançamentos..." )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "A gerar lançamentos...", "Gerando lançamentos..." )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", "Filtrar os lançamentos existentes para exclusão do processo seleccionado ?", "Filtrar os lancamentos existentes para exclusao do processo selecionado ?" )
		#define STR0017 "Sim"
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Não", "Nao" )
		#define STR0019 "[ Excluir os Movimentos - AMJ ]"
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Filtro não informado. Operação cancelada!", "Filtro nao informado. Operacao Cancelada!" )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Confirma a exclusão de todos os lançamentos para o processo seleccionado?", "Confirma a exclusao de todos os lancamentos para o processo selecionado?" )
		#define STR0022 "Filial de"
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Filial até", "Filial ate" )
		#define STR0024 "Verifique o conteúdo do parâmetro MV_PCOINTE."
		#define STR0025 "Para qualquer integração, este parâmetro deverá conter o valor 1"
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "A apagar movimentos ...", "Apagando Movimentos ..." )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Erro na exclusão de movimentos ", "Erro na exclusao de movimentos " )
		#define STR0028 "Processo cancelado..."
		#define STR0029 "Visualizar Log"
		#define STR0030 "Importar XML"
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Não foi possível copiar o ficheiro XML para o Servidor Protheus na pasta ", "Não foi possível copiar o arquivo XML para o Servidor Protheus na pasta " )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "Filtrar os lançamentos XML existentes para exclusão do período seleccionado ?", "Filtrar os lancamentos XML existentes para exclusao do periodo selecionado ?" )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Confirma a exclusão de todos os lançamentos XML do período seleccionado?", "Confirma a exclusao de todos os lancamentos XML do periodo selecionado?" )
		#define STR0034 "Visualizar"
		#define STR0035 "Incluir"
		#define STR0036 "Alterar"
		#define STR0037 "Excluir"
		#define STR0038 "Detalhes do erro na gravação do XML."
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Ficheiro processado com sucesso!", "Arquivo Processado com Sucesso!" )
		#define STR0040 If( cPaisLoc $ "ANG|PTG", "Não foi possível deletar o ficheiro: ", "Não foi possível deletar o arquivo: " )
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Problemas encontrados na estrutura do XML", "Problemas encontrados na Estrutura do XML" )
		#define STR0042 If( cPaisLoc $ "ANG|PTG", "A tabela AMJ não está no dicionário.", "A tabela AMJ nao está no dicionario." )
		...
		#define STR0047 "Verificar as permissões de leitura ou escrita das pastas."
		#define STR0048 If( cPaisLoc $ "ANG|PTG", "Verifique se todos os campos do ficheiro XML estão em conformidade com o layout definido para o mesmo.", "Verifique se todos os campos do arquivo XML estão em conformidade com o layout definido para o mesmo." )
		#define STR0049 If( cPaisLoc $ "ANG|PTG", "Tabela utilizada no Ponto de Lançamento não é uma tabela válida. Verifique o dicionário de dados.", "Tabela utilizada no Ponto de Lançamento não é uma tabela válida, verifique o dicionário de dados." )
		#define STR0050 If( cPaisLoc $ "ANG|PTG", "Não existem pontos de lançamento para integração registados ou não existe nenhum activo. Verifique o procedimento em Actualizações > Lançamentos > Pontos Lanç.Integr.", "Não existem pontos de lançamento para integração cadastrados, ou não existe nenhum ativo. Verifique a rotina em Atualizações > Lançamentos > Pontos Lanc Integr." )
		#define STR0051 If( cPaisLoc $ "ANG|PTG", "A tabela informada no campo AKB_ENTIDA não existe no dicionário de dados. Verifique o registo em Actualizações > Lançamentos > Pontos Lanç.Integr.", "A tabela informada no campo AKB_ENTIDA não existe no dicionário de dados, verifique o cadastro em Atualizações > Lançamentos > Pontos Lanc Integr." )
		#define STR0052 If( cPaisLoc $ "ANG|PTG", "Ficheiro contém operação ?", "Arquivo contém Operação ?" )
		#define STR0053 If( cPaisLoc $ "ANG|PTG", "Ficheiro contém centro custo ?", "Arquivo contém Centro Custo ?" )
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Ficheiro contém item contabilístico ?", "Arquivo contém Item Contábil ?" )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", "Ficheiro contém classe valor ?", "Arquivo contém Classe Valor ?" )
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "Um ou mais campos nos pontos de lançamentos de integração não estão correctos. Verifique o tipo do campo informado.", "Um ou mais campos nos pontos de lançamentos de integração não estão corretos. Verifique o tipo do campo informado." )
		#define STR0057 If( cPaisLoc $ "ANG|PTG", "O ficheiro contém unid. orçamentária?", "Arquivo contém Unid. Orçamentária?" )
		#define STR0058 If( cPaisLoc $ "ANG|PTG", "O ficheiro contém ", "Arquivo contém " )
	#endif
#endif
