#ifdef SPANISH
	#define STR0001 " TITULOS POR COBRAR RECHAZADOS:"
	#define STR0002 "Este programa imprimira el Informe de Titulos"
	#define STR0003 "por Cobrar que tengan los pagos rechazados por la"
	...
	#define STR0018 "Creando Archivo Temporario..."
#else
	#ifdef ENGLISH
		#define STR0001 " REFUSED BILLS RECEIVABLE"
		#define STR0002 "This program prints the report of"
		#define STR0003 "Bills Receivable that had payment refused by"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", " TÍTULOS A RECEBER RECUSADOS", " TITULOS A RECEBER RECUSADOS" )
		...
		#define STR0003 "a Receber que tiveram os pagamentos recusados pela"
