	...
	#define STR0015 "Log de Inconsistencia al Borrar Competencias"
	#define STR0016 "Intentando acceder al registro."
	#define STR0017 "Intentando acceder a los registros."
	#define STR0018 "¿Abandonar las modificaciones?"
	#define STR0019 "El sistema hara la verificacion para ver si el registro seleccionado"
	#define STR0020 "para borrar lo estan utilizando. La verificacion podra tardar."
	...
	#define STR0025 "¿Desea generar Log?"
		...
		#define STR0015 "Log of Inconsistency during Competence Deletion"
		#define STR0016 "Trying to access the record."
		#define STR0017 "Trying to access the records."
		#define STR0018 "Abort the changes?"
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Log De Inconsistência Na Exclusão De Competências", "Log de Inconsistencia na Exclusao de Competencias" )
		...
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Abandonar as alterações?", "Abandonar as altera‡”es?" )
