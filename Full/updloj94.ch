	...
	#define STR0004 "Esta rutina actualizara los diccionarios de datos para utilizacion de "
	#define STR0005 "nuevas funcionalidades de SIGALOJA/FRT."
	#define STR0006 "Importante : "
	#define STR0007 "1. ¡No deben haber usuarios utilizando el sistema durante la "
	...
	#define STR0017 "Esta rutina solo se destina a la localidad Brasil."
	...
	#define STR0025 "Ocurrio un error durante la actualizacion de la estructura de la tabla: "
	...
	#define STR0033 "AJUSTES EN SX3 : "
	#define STR0034 "Codigo de grupo que tiene permiso de crear una "
	#define STR0035 "nueva sugerencia de lista a partir de una ya exist"
	#define STR0036 "ente."
	#define STR0037 "- Inclusion de parametro: "
	#define STR0038 "AJUSTES EN SX6: "
	#define STR0039 "¡El archivo de empresas no se puede abrir en modo exclusivo!"
	...
	#define STR0044 "- Modificacion de campo : "
	#define STR0045 "Cantidad de Producto"
	#define STR0046 "UpdLoj94"
	#define STR0047 "*OFF"
	#define STR0048 "SEL"
	...
	#define STR0055 "Codigo del Producto"
#else
	#ifdef ENGLISH
		...
		#define STR0034 "Group Code has permission to create new"
		#define STR0035 "list suggestion from pre existent list"
		#define STR0036 "existent list."
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "2. Indices personalizados que estejam em conflito com índices que ", "2. Indices customizados que estejam em conflito com índices que " )
		...
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "LOG DE ATCUALIZAÇÃO:", "LOG DE ATUALIZAÇÃO:" )
		...
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "Código do grupo que tem permissão para criar uma nov", "Codigo do grupo que tem permissao de criar uma nov" )
		...
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "O ficheiro de empresas não pode ser aberto em modo exclusivo.", "O arquivo de empresas não pode ser aberta em modo exclusivo!" )
		...
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "Operação cancelada.", "Operação cancelada!" )
		...
		#define STR0055 If( cPaisLoc $ "ANG|PTG", "Código do artigo", "Codigo do Produto" )
	#endif
#endif
