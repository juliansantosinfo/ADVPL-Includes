#ifdef SPANISH
	#define STR0001 "UpDate UPDCOM28"
	#define STR0002 "Atualizacion de los indices de las tablas: "
	...
	#define STR0005 "La rutina de actualizacion ajustara los indices de las tablas: "
	#define STR0006 "Antes de iniciar la actualizacion, debe leer y aceptar los terminos y las condiciones a seguir. Despues de aceptarlos, puede continuar con la actualizacion."
	#define STR0007 "ATENCION:"
	#define STR0008 "Este update tem como objetivo ajustar en el diccionario los datos de los indices: "
	#define STR0009 " "
	...
	#define STR0057 "Se creo un nuevo indice en el diccionario de datos: "
	...
	#ifdef ENGLISH
		#define STR0001 "Update UPDCOM28"
		#define STR0002 "Table indexes update: "
		...
		#define STR0005 "The update routine adjusts the table indexes: "
		...
		#define STR0008 "This update aims at adjusting the indexes in the data dictionary: "
		#define STR0009 " "
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Update UPDCOM28", "UpDate UPDCOM28" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Actualização dos índices das tabelas: ", "Atualização dos índices das tabelas: " )
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "O procedimento de actualização ajustará os índices das tabelas: ", "A rotina de atualização irá ajustar os índices das tabelas: " )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Este update tem como objectivo ajustar no dicionário de dados os índices: ", "Este update tem como objetivo ajustar no dicionário de dados os índices: " )
