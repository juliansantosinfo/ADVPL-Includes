#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 00000008261/2010. "
	...
	#define STR0004 "FNC 00000008261/2010"
	...
	#define STR0029 "Ok"
	#define STR0030 "Esta FNC crea los campos necesarios para la recepcion de titulos en moneda diferente del estandar. Venta con impuesto interno y la grabacion de los datos del informe Z en la impresora Hasar SMH/P-435F. "
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with FNC 00000008261/2010. "
		...
		#define STR0029 "OK"
		#define STR0030 "This FNC creates fields necessary to receive bills in a currency different from the standard. Sales with internal tax and saving of Z reduction data in printer Hasar SMH/P-435F. "
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função da FNC 00000008261/2010. ", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 00000008261/2010. " )
		...
		#define STR0011 "Empresa : "
		#define STR0012 "Início - Dicionário de Dados"
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Início A Actualizar Estruturas ", "Início Atualizando Estruturas " )
		...
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Início - A Abrir Tabelas", "Início - Abrindo Tabelas" )
		...
		#define STR0029 "Ok"
		#define STR0030 "Esta FNC cria os campos necessários para o recebimento de títulos em moeda diferente do padrão. Venda com imposto interno e a gravação dos dados da redução Z na impressora Hasar SMH/P-435F. "
	#endif
#endif
