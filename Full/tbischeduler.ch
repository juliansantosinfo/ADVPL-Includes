#ifdef SPANISH
	#define STR0001 "Se finalizo el scheduler."
	#define STR0002 "No se puede inicializar el scheduler, pues esta en ejecucion."
	#define STR0003 "No se puede inicializar el scheduler. Verifique los atributos de grabacion."
	#define STR0004 "Iniciando el Scheduler ..."
	#define STR0005 "Error al recalcular Scheduler."
	#define STR0006 "Scheduler en ejecucion."
	...
	#define STR0009 "Accion: "
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "O Scheduler não pode ser inicializado, pois já está em execução.", "O Scheduler não pode ser inicializado, pois o mesmo já esta em execução!" )
