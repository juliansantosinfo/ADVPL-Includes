#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion del BOPS 145598. "
	...
	#define STR0029 "Ok"
#else
	#ifdef ENGLISH
		#define STR0001 "The purpose of this program is to adjust data dictionaries due to BOPS 145598. "
		#define STR0002 "This routine must be processes in exclusive mode! "
		...
		#define STR0015 "Starting Update of Structures "
		...
		#define STR0029 "Ok"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo    ajustar os dicionários de dados em função  do bops 145598. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 145598. " )
		...
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Bops 145598", "BOPS 145598" )
