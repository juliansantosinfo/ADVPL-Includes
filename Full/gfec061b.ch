	...
	#define STR0009 "Registro no se utilizara para el total de flete"
		...
		#define STR0009 "Record is not used for freight total."
	#else
		...
		#define STR0007 "Copiar"
		#define STR0008 "Imprimir"
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Registo não será utilizado para o total de frete", "Registro não será utilizado para o total de frete" )
	#endif
#endif
