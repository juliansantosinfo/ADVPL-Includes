	...
	#define STR0003 "Metodo de listado de informaciones de registro de la tabla de ocurrencias del Field Service"
#else
	#ifdef ENGLISH
		...
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Método De Listagem Das Informações De Registo Da Tabela De Ocorrências Do Field Service", "Método de listagem das informações cadastrais da tabela de ocorrências do Field Service" )
	#endif
#endif
