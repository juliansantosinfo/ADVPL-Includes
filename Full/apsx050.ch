	...
	#define STR0020 "Borrar"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX5", "Registro - SX5" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SX5 - ENGLISH", "Tradução SX5 - INGLÊS" )
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SX5 - SPANISH", "Tradução SX5 - ESPANHOL" )
