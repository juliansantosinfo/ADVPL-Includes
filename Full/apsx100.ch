	...
	#define STR0018 "Borrar"
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Tradução SXA - ENGLISH", "Tradução SXA - INGLÊS" )
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Tradução SXA - SPANISH", "Tradução SXA - ESPANHOL" )
