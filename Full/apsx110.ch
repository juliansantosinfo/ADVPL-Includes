	...
	#define STR0020 "Borrar"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SXB", "Registro - SXB" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SXB - ENGLISH", "Tradução SXB - INGLÊS" )
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SXB - SPANISH", "Tradução SXB - ESPANHOL" )
