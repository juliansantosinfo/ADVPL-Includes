#ifdef SPANISH
	#define STR0001 "%99n# - Proxima tentativa de conexao em 20 segundos."
	#define STR0002 "%99n# - Ultima tentativa de conexao em 20 segundos."
	#define STR0003 "Discando a conexao Dial-up"
	#define STR0004 "Nao foi possivel discar a conexao Dial-up."
	#define STR0005 "Desconectando a conex„o Dial-up"
...
#else
	#ifdef ENGLISH
		#define STR0001 "%99n# - Next attempt to connect in 20 seconds."
		#define STR0002 "%99n# - Last attempt to connect in 20 seconds."
		#define STR0003 "Trying Dial-up connection"
		#define STR0004 "Unable to establish Dial-up connection."
		#define STR0005 "Disconnecting Dial-up"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "%99n# - prÛxima tentativa de conex„o em 20 segundos.", "%99n# - Proxima tentativa de conexao em 20 segundos." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "%99n# - ˙ltima tentativa de ligaÁ„o dentro de 20 segundos.", "%99n# - Ultima tentativa de conexao em 20 segundos." )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "A Fazer A LigaÁ„o Dial-up", "Discando a conexao Dial-up" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "N„o Foi PossÌvel Fazer A LigaÁ„o Dial-up.", "Nao foi possivel discar a conexao Dial-up." )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "A Terminar A LigaÁ„o Dial-up", "Desconectando a conex„o Dial-up" )
