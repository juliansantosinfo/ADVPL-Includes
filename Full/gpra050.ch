#ifdef SPANISH
	#define STR0001 "Registro de Grupos de Encuestas"
	...
	#define STR0008 "La encuesta a la cual pertenece este grupo de alternativas se encuentra activa, pero sin respuestas."
	...
	#define STR0011 "¿Confirma el borrado del grupo y posibles subgrupos relacionados al mismo ?"
#else
	#ifdef ENGLISH
		...
		#define STR0011 "Do you confirm the group deletion and possible subgroups linked to it ?"
	#else
