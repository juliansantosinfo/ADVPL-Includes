	...
	#define STR0011 "       RECIBO DE PAGAMENTO DE AUTONOMO  - RPA     +-------- Nº.RECIBO ---------+"
	#define STR0012 "                                                  |                            |"
	#define STR0013 "+-------------------------------------------------+----------------------------+"
	...
	#define STR0022 "| Nº INSS :                             | I VALOR DE SERVICIO....               "
	...
	#define STR0039 "Seleccionando Registros de Movimentos Anteriores"
		...
		#define STR0012 "                                                  |                            |"
		#define STR0013 "+-------------------------------------------------+----------------------------+"
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "| nome ou razão social da empresa          |   registo (n.cont. ou s.s.)  |", "| NOME OU RAZAO SOCIAL DA EMPRESA                 |   MATRICULA (CNPJ ou INSS)  |" )
		#define STR0015 "|                                                 |                            |"
		#define STR0016 "+-------------------------------------------------+----------------------------+"
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "           Recebi Da Empresa Acima Identificada, Pela Prestação   Dos Serviços De", "           RECEBI DA EMPRESA ACIMA IDENTIFICADA, PELA PRESTACAO DOS SERVICOS  DE" )
		#define STR0018 "                                                                                "
		...
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "| na s.s. :                             | i valor do serviço.....               ", "| NO INSS :                             | I VALOR DO SERVICO.....               " )
		...
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "| órgão  emissor :          dist. :         | descontos:                            ", "| ORGAO EMISSOR :          UF :         | DESCONTOS:                            " )
