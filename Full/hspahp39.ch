	...
	#define STR0010 "Solicitud até 15 min.     "
	...
	#define STR0069 "No se encontro ningun registro"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Pedidos", "Solicitações" )
		...
		#define STR0016 If( cPaisLoc $ "ANG|PTG", "Empregado Para Entrega", "Funcionário para Entrega" )
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "Spp - Retorno", "SPP - RETORNO" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Empregado Que Retornou", "Funcionário que Retornou" )
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "Spp - Encerrar Solicitação", "SPP - ENCERRA SOLICITAÇÃO" )
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Código de Barras(Pront.+Mor.+Reg.Atend)", "Código de Barras(Pront.+Ender.+Reg.Atend)" )
		#define STR0021 "Nome    : "
		...
		#define STR0027 "Saída Programada"
		#define STR0028 "Unificar Pront."
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Extracto", "Extrato" )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Opção Apenas Disponível Para Prontuários Ainda Não Atendidos.", "Opção somente disponível para prontuários ainda Não Atendidos." )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Spp - Observação Da Solicitação", "SPP - Observação da Solicitação" )
		#define STR0032 "Observação: "
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Prontuário não retornado ao spp. a solicitação não pode ser atendida.", "Prontuário não Retornado ao SPP. A solicitação não pode ser atendida." )
		#define STR0034 "Atenção"
		#define STR0035 If( cPaisLoc $ "ANG|PTG", "Relação prontuário x morada não existe.", "Relacionamento Prontuário x Endereço não existe." )
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "Prontuário já solicitado para o sector.", "Prontuário já solicitado para o setor." )
		#define STR0037 "Prontuário não encontrado."
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "Morada não está activa.", "Endereço não está ativo." )
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Esta morada de prontuário é externa, o prazo para a entrega das fichas é de : ", "Este endereço de prontuário é externo, o prazo para a entrega das fichas é de : " )
		#define STR0040 " dias."
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Consulta Da Movimentação", "Consulta da Movimentação" )
		#define STR0042 "Saída Múltipla"
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "Nenhuma solicitação encontrada para o prontuário indicado.", "Nenhuma solicitação encontrada para o prontuário informado." )
		#define STR0044 If( cPaisLoc $ "ANG|PTG", "Validação dos parâmetros", "Validação dos Parâmetros" )
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "Sector não registado.", "Setor não cadastrado." )
		#define STR0046 If( cPaisLoc $ "ANG|PTG", "Procedimento não registado.", "Procedimento não cadastrado." )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", "Médico não registado.", "Médico não cadastrado." )
		#define STR0048 If( cPaisLoc $ "ANG|PTG", "Motivo não registado.", "Motivo não cadastrado." )
		#define STR0049 "Consultar"
		#define STR0050 "Paciente"
		#define STR0051 If( cPaisLoc $ "ANG|PTG", "Extracto Atend.", "Extrato Atend." )
		#define STR0052 If( cPaisLoc $ "ANG|PTG", "Prontuário não está relacionado com nenhuma morada.", "Prontuário não está relacionado com nenhum endereço." )
		#define STR0053 "Agenda"
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Não é Possível Atender A Esta Solicitação, Pois O Prontuário Indicado Ainda Não Retornou Ao Spp.", "Não é possivel atender a esta solicitação, pois o prontuário informado ainda não retornou ao SPP." )
		#define STR0055 "Atendimento de solicitação"
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "Já existe uma solicitação não atendida para o prontuário. deseja atender a esta solicitação?", "Já existe uma solicitação não atendida para o prontuário. Deseja atender a esta solicitação?" )
		#define STR0057 If( cPaisLoc $ "ANG|PTG", "Prontuário já relacionado. deseja recuperá-lo?", "Prontuário já relacionado. Deseja recuperá-lo?" )
		#define STR0058 If( cPaisLoc $ "ANG|PTG", "Prontuário já relacionado. deseja excluí-lo da lista?", "Prontuário já relacionado. Deseja excluí-lo da lista?" )
		#define STR0059 If( cPaisLoc $ "ANG|PTG", "Protocolo De Atendimento", "Protocolo de Atendimento" )
		#define STR0060 If( cPaisLoc $ "ANG|PTG", "Nenhuma solicitação encontrada para o prontuário e morada indicados.", "Nenhuma solicitação encontrada para o prontuário e endereço informado." )
		#define STR0061 "Já existe uma solicitação ["
		#define STR0062 If( cPaisLoc $ "ANG|PTG", "] não atendida para o prontuário/morada. a solicitação foi criada em ", "] não atendida para o prontuário/endereço. A solicitação foi gerada em " )
		#define STR0063 If( cPaisLoc $ "ANG|PTG", " os ", " às " )
		#define STR0064 If( cPaisLoc $ "ANG|PTG", " para o sector ", " para o setor " )
		#define STR0065 If( cPaisLoc $ "ANG|PTG", ". confirmar a nova solicitação?", ". Confirma a nova solicitação?" )
		#define STR0066 If( cPaisLoc $ "ANG|PTG", "] atendida e não retornada para o prontuário/morada. a solicitação foi criada em ", "] atendida e não retornada para o prontuário/endereço. A solicitação foi gerada em " )
		#define STR0067 If( cPaisLoc $ "ANG|PTG", "Consultar lote", "Consulta lote" )
		#define STR0068 If( cPaisLoc $ "ANG|PTG", "Código Do Lote", "Código do Lote" )
