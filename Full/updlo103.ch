	...
	#define STR0020 "¡No fue posible la apertura de la tabla de empresas de forma exclusiva!"
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Actualização da validação do campo LR_PRODUTO", "Atualizacao da Validação do Campo LR_PRODUTO" )
		...
		#define STR0019 If( cPaisLoc $ "ANG|PTG", " SLR - LR_PRODUTO - Validação ", " SLR - LR_PRODUTO - Validacao " )
