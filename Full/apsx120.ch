	...
	#define STR0018 "Borrar"
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Tradução SXD - ENGLISH", "Tradução SXD - INGLÊS" )
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Tradução SXD - SPANISH", "Tradução SXD - ESPANHOL" )
