	...
	#define STR0003 "Tabla de Terminaciones (F03)."
	...
	#define STR0014 "¿Directorio p/Import.?"
		...
		#define STR0003 "Finish Table (F03)."
		#define STR0004 "Wait..."
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Este programa importa o ficheiro contendo a", "Este programa importa o arquivo contendo a" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Tabela de acabamentos (F03).", "Tabela de Acabamentos (F03)." )
