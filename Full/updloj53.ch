#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 000000281772009."
	...
	#define STR0004 "FNC 000000281772009"
	...
	#define STR0029 "Ok"
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries in accordance with FNC 000000281772009."
		...
		#define STR0029 "OK"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função do FNC 000000281772009.", "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 000000281772009." )
