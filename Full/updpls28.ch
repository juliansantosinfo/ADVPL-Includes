#ifdef SPANISH
	#define STR0001 "Compatibilizador de Diccionarios vs. Banco de datos"
	#define STR0002 "Cantidad de US Utilizada"
	#define STR0003 "Esta rutina va a efectuar la compatibilizacion de los diccionarios y banco de datos,"
	#define STR0004 "y demas ajustes referentes a FNC abajo:"
	#define STR0005 "   FNC: "
	#define STR0006 "   Referencia: "
	#define STR0007 "Atencion: efectuar backup de diccionarios y del banco de datos previamente "
	#define STR0008 "Compatibilizador"
	#define STR0009 "¿Desea confirmar el procesamiento de compatibilizador ?"
	#define STR0010 "Si"
	#define STR0011 "No"
	...
	#define STR0053 "Cantidad de US Utilizada"
	#define STR0054 'Cant. de US'
	#define STR0055 "Informe la cantidad de US maxima que "
	#define STR0056 "cada usuario de este producto podra utilizar."
	#define STR0057 'Periodo'
	#define STR0058 "Informe el numero correspondiente al "
	#define STR0059 "periodo de busqueda del historial del "
	#define STR0060 "usuario para calcular la cantidad de "
	#define STR0061 "US utilizada por este."
	#define STR0062 'Unidad'
	#define STR0063 '1=Dias;2=Meses;3=Anos'
	#define STR0064 "Informe la unidad de medida de tiempo "
	#define STR0065 "correspondiente al numero informado "
	#define STR0066 "en el campo Periodo"
	#define STR0067 "cada usuario de este subcontrato podra utilizar."
#else
	#ifdef ENGLISH
		#define STR0001 "Compatibility Program of Dictionaries x Database"
		#define STR0002 "Number of US Used"
		...
		#define STR0053 "Number of US Used"
		#define STR0054 'Number of US'
		#define STR0055 "Enter the maximum number of US that "
		#define STR0056 "each user of this product can use."
		#define STR0057 'Period'
		#define STR0058 "Enter the number corresponding to the "
		#define STR0059 "search period for history of "
		#define STR0060 "user to calculate the number of "
		#define STR0061 "US already used."
		#define STR0062 'Unit'
		#define STR0063 '1=Days;2=Months;3=Years'
		#define STR0064 "Enter the time unit of measurement "
		#define STR0065 "corresponding to the number entered "
		#define STR0066 "in field Period"
		#define STR0067 "each user of this subcontract can use."
	#else
		...
		#define STR0002 "Quantidade de US Utilizada"
		...
		#define STR0053 "Quantidade de US Utilizada"
		#define STR0054 If( cPaisLoc $ "ANG|PTG", 'Qtd. de US', 'Quant. de US' )
		#define STR0055 "Informe a quantidade de US máxima que "
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "cada utilizador deste artigo poderá utilizar.", "cada usuário deste produto poderá utilizar." )
		#define STR0057 If( cPaisLoc $ "ANG|PTG", 'Período', 'Periodo' )
		#define STR0058 "Informe o numeral que corresponderá ao "
		#define STR0059 "período de pesquisa ao histórico do "
		#define STR0060 If( cPaisLoc $ "ANG|PTG", "utilizador para calcular a quantidade de ", "usuário para calcular a quantidade de " )
		#define STR0061 "US já utilizada por ele."
		#define STR0062 'Unidade'
		#define STR0063 '1=Dias;2=Meses;3=Anos'
		#define STR0064 "Informe a unidade de medida de tempo "
		#define STR0065 "correspondente ao numeral informado "
		#define STR0066 "no campo Período"
		#define STR0067 If( cPaisLoc $ "ANG|PTG", "cada utilizador deste subcontrato poderá utilizar.", "cada usuário deste subcontrato poderá utilizar." )
	#endif
#endif
