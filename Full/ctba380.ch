	...
	#define STR0024 "Verifique la creacion de los campos CTH_CLVM y CTH_CLRED."
		...
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "Moeda não poderá ser '01'.", "Moeda nao podera ser '01'." )
		...
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Verificar a criação dos campos ctt_ccvm e ctt_ccred.", "Verifique a criação dos campos CTT_CCVM e CTT_CCRED." )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Contactar O Administrador.", "Contate o Administrador." )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Verificar a criação dos campos ctd_itvm e ctd_itred.", "Verifique a criação dos campos CTD_ITVM e CTD_ITRED." )
		#define STR0024 If( cPaisLoc $ "ANG|PTG", "Verificar a criação dos campos cth_clvm e cth_clred.", "Verifique a criação dos campos CTH_CLVM e CTH_CLRED." )
	#endif
#endif
