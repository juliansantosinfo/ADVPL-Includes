	...
	#define STR0031 "Campo LG_IMPCUFA registrado"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função da FNC 85112009.", "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 85112009." )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Campo LG_IMPCUFA já registado", "Campo LG_IMPCUFA jÁ cadastrado" )
	#endif
#endif
