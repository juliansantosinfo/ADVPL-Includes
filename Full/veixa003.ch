#ifdef SPANISH
	#define STR0001 "Entrada de Vehiculos por Remesa"
...
#else
	#ifdef ENGLISH
		#define STR0001 "Inflow of Vehicles per Remittance"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Entrada de Veículos por Remessa", "Entrada de Veiculos por Remessa" )
