	...
	#define STR0059 "Se creo una clave unica de la tabla "
	...
	#define STR0093 "Se selecciono la opcion REALIZAR TODAS las modificaciones en el SX3 y NO MOSTRAR mas la pantalla de aviso."
	#define STR0094 "Se selecciono la opcion NO REALIZAR ninguna modificacion en el SX3 que sea diferente de la base y NO MOSTRAR mas la pantalla de aviso."
	...
	#define STR0136 "Atualizado el Help de preguntas "
	...
	#define STR0143 "Clave del indice modificado "
		...
		#define STR0084 If( cPaisLoc $ "ANG|PTG", "Índice alterado ", "Indice alterado " )
		#define STR0085 If( cPaisLoc $ "ANG|PTG", "A actualizar índices...", "Atualizando índices..." )
		#define STR0089 "Foi incluída a consulta padrão "
		#define STR0090 If( cPaisLoc $ "ANG|PTG", "A consulta padrão ", "A consulta padrao " )
		#define STR0091 ", e este é diferente do conteúdo"
		#define STR0093 If( cPaisLoc $ "ANG|PTG", "Foi seleccionada a opção de REALIZAR TODAS alterações no SXB e NÃO MOSTRAR mais o ecrã de aviso.", "Foi selecionada a opção de REALIZAR TODAS alterações no SXB e NÃO MOSTRAR mais a tela de aviso." )
		#define STR0094 If( cPaisLoc $ "ANG|PTG", "Foi seleccionada a opção de NÃO REALIZAR nenhuma alteração no SXB que esteja diferente da base e NÃO MOSTRAR mais o ecrã de aviso.", "Foi selecionada a opção de NÃO REALIZAR nenhuma alteração no SXB que esteja diferente da base e NÃO MOSTRAR mais a tela de aviso." )
