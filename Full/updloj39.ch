	...
	#define STR0036 "Turno de Entrega"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função da FNC 278602009 .", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 278602009 ." )
		...
		#define STR0029 "Ok"
		#define STR0030 "Turno padrão para entrega, M - manhã"
		#define STR0031 " , T - tarde e N - noite."
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "Quantidade de dias a adicionar à data de entrega.", "Quantidade de dias a adicionar a data de entrega." )
		#define STR0033 "Define quais serão os campos utilizados para a "
		#define STR0034 "quebra na geração dos Orçamentos Filho e Pedidos "
