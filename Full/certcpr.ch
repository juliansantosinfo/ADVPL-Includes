#ifdef SPANISH
	#define STR0001 "Certificado de Retencion de Publicidad"
	#define STR0002 "Impuesto Sobre Publicidad"
	#define STR0003 "Jurisdiccion"
	#define STR0004 "Agente de Retencion"
	#define STR0005 "Nº CUIT"
	#define STR0006 "Razon Social"
	#define STR0007 "Direccion"
	#define STR0008 "Lugar de Pago"
	#define STR0009 "Datos del Contribuyente sujeto a Retencion"
	#define STR0010 "Proveedor"
	#define STR0011 "Direccion"
	#define STR0012 "Estado"
	#define STR0013 "Nº CPR"
	...
	#define STR0022 "Vl Imp."
	#define STR0023 "Retenc."
	#define STR0024 "Firma:"
	#define STR0025 "Comprobante de Retencion"
	#define STR0026 "Alicuota"
	#define STR0027 "Referencia"
	#define STR0028 "Informaciones de la declaracion del mes de"
	#define STR0029 "Del ano de"
#else
	#ifdef ENGLISH
		#define STR0001 "Advertising Withholding Certificate"
		#define STR0002 "Tax on Advertising"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Certificado de Retenção de Publicidade", "Certificado de Retencao de Publicidade" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Imposto sobre publicidade", "Imposto Sobre Publicidade" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Jurisdição", "Jurisdicao" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Agente de retenção", "Agente de Retencao" )
		#define STR0005 "Nº CUIT"
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Razão social", "Razao Social" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Morada", "Endereco" )
		#define STR0008 "Lugar de Pago"
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Dados do contribuinte sujeito a retenção", "Dados do Contribuinte sujeito a Retencao" )
		...
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Vlr. imp.", "Vl Imp." )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Retenç.", "Retenc." )
		#define STR0024 "Assinatura:"
		#define STR0025 If( cPaisLoc $ "ANG|PTG", "Comprovante de retenção", "Comprovante de Retencao" )
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Alíquota", "Aliquota" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Referência", "Referencia" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Informações da declaração do mês de", "Informacoes da declaracao do mes de" )
