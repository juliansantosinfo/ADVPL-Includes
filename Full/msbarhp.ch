	...
	#else
		#define STR0001 "Obrigatorio o tipo ser EAN128"
		#define STR0002 "***Conteudo invalido para codigo EAN13***"
		#define STR0003 "***Conteudo invalido para codigo EAN8***"
		#define STR0004 "***Conteudo invalido para codigo UPCA***"
		#define STR0005 "***Codigo de barras com Banner nao disponivel p/ vertical****"
	#endif
#endif
