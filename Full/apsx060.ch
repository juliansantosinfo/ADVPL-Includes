	...
	#define STR0020 "Borrar"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX6", "Registro - SX6" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SX6 - ENGLISH", "Tradução SX6 - INGLÊS" )
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SX6 - SPANISH", "Tradução SX6 - ESPANHOL" )
