	...
	#define STR0029 "Total"
		...
		#define STR0029 "Total"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa irá imprimir o Balanço Crial Modelo 1 (132) colunas.", "Este programa ira imprimir o Balanco Geral Modelo 1 (132) Colunas." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "A conta é impressa, limitando-se a 30 caracteres e a sua descrição a 40 caracteres,", "A conta eh impressa limitando-se a 30 caracteres e sua descricao 40 caracteres," )
		...
		#define STR0024 If( cPaisLoc $ "ANG|PTG", "Código Reduzido", "CODIGO REDUZIDO" )
		#define STR0025 If( cPaisLoc $ "ANG|PTG", "Descrição Da Conta", "DESCRICAO DA CONTA" )
		...
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Balanço Modelo I", "Balanco Modelo I" )
		#define STR0029 "Total"
	#endif
#endif
