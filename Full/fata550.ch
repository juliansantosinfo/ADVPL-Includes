	...
	#define STR0002 "Archivo de Tipo de Tarea"
	#define STR0003 "Este registro se encuentra vinculado al archivo de Componentes vs. Tp. Tarea, por favor verifique."
	...
	#define STR0009 "Borrar"
		...
		#define STR0002 "Task Type Register"
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Registo de Tipo de Tarefa", "Cadastro de Tipo de Tarefa" )
