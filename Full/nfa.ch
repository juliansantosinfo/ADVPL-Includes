	...
	#define STR0041 "Factura Final"
		...
		#define STR0002 "Operação Cancelada!"
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Série Unica   : ", "Serie Unica   : " )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Caso continue com a criação, ", "Caso continue com a geração, " )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "todos registos tipo 20 que não possuirem vínculo serão criados com série tipo : ", "todos registros tipo 20 que não possuirem amarração serão gerados com serie tipo : " )
		#define STR0010 "Cancela"
		#define STR0011 "Continua"
		#define STR0012 "Data Inicial "
		#define STR0013 "Data Final "
		#define STR0014 "Ok"
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Assistente de parametrização da NFA Factura Alagoana", "Assistente de parametrização da NFA Nota Fiscal Alagoana" )
		#define STR0016 "Atenção"
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "Preencha as informações solicitadas para a criação do ficheiro magnetico", "Preencha as informações solicitadas para a geração do arquivo magnetico" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Criação de informações da NFA Factura Alagoana - Sefaz AL", "Geração de informações da NFA Nota Fiscal Alagoana - Sefaz AL" )
		#define STR0019 "Assistente de parametrização"
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Configuração do período e parâmetros da criação : ", "Configuração do período e parametros da geração : " )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Séries Tipo D (Ex : '001','2  ','UNI')", "Series Tipo D (Ex : '001','2  ','UNI')" )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Séries Tipo D Única (Ex : '001','2  ','UNI')", "Series Tipo D Unica (Ex : '001','2  ','UNI')" )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Séries Tipo Única (Ex : '001','2  ','UNI')", "Series Tipo Unica (Ex : '001','2  ','UNI')" )
		#define STR0024 If( cPaisLoc $ "ANG|PTG", "Empresa efectua venda a prazo?", "Empresa efetua venda à prazo?" )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Directório de Criação", "Diretorio de Geracao" )
		...
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "Diminua o período de criação e tente criar novamente.", "Diminua o periodo de geração e tente gerar novamente." )
