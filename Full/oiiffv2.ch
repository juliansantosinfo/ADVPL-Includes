	...
	#define STR0002 "Este programa importa el archivo que contiene la Anulacion de "
	#define STR0003 "Facturacion de vehiculos (FV2)."
	...
	#define STR0013 "Identif.Distrib.    ?"
		...
		#define STR0002 "This program exports the file with the cancellation of "
		#define STR0003 "Invoicing of Vehicles (FV2)."
		#define STR0004 "Wait..."
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Este programa exporta o ficheiro contendo o cancelamento de ", "Este programa exporta o arquivo contendo o Cancelamento de " )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Facturação de veículos (FV2).", "Faturamento de Veículos (FV2)." )
