	...
	#define STR0029 "Ok"
		...
		#define STR0029 "OK"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objetivo ajustar os dicionarios de dados em função do bops 130135. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 130135. " )
