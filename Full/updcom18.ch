#ifdef SPANISH
	#define STR0001 "Update UPDCOM18"
	#define STR0002 'Implementac. de campos da DANFE'
	...
	#define STR0005 'Antes de iniciar la actualizacion, lea y acepte los siguientes terminos y condiciones. Despues de aceptarlos, puede continuar con la actualizacion.'
	#define STR0006 'Antes de iniciar la actualizacion, lea y acepte los siguientesterminos y condiciones. Despues de aceptarlos, puede continuar con la actualizacion.'
	#define STR0007 'ATENCION:'
	#define STR0008 'Este update tiene como objetivo crear en el diccionario de datos nuevos campos necesarios para la implementacion de las actualizaciones referentes a DANFE'
	#define STR0009 ''
	#define STR0010 'IMPORTANTE: El diccionario se actualizara de tal manera que no se modifique el tratamiento actual del sistema.'
	...
	#define STR0055 'Actualizada la estructura del archivo: '
	...
	#ifdef ENGLISH
		#define STR0001 "Update UPDCOM18"
		#define STR0002 'Implementation of DANFE Fields'
		#define STR0003 'Progress of each table adjustment:'
		#define STR0004 'Warning: To make the adjustment, NO user can use the system!'
		#define STR0005 'Before starting the update, you must read and accept the following terms and conditions. Once you accept them, you can proceed with the update.'
		...
		#define STR0008 'This update creates necessary new fields in the data dictionary to implement DANFE updates.'
		#define STR0009 ''
	...
	#else
		#define STR0001 "Update UPDCOM18"
		#define STR0002 'Implementação de Campos da DANFE'
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", 'Este update tem como objetivo criar no dicionário de dados novos campos necessários para implementação das actualizações referentes à DANFE', 'Este update tem como objetivo criar no dicionário de dados novos campos necessários para implementação das atualizações referente a DANFE' )
		#define STR0009 ''
		#define STR0010 If( cPaisLoc $ "ANG|PTG", 'IMPORTANTE: o dicionário será atualizado de forma a não alterar o funcionamento actual do sistema.', 'IMPORTANTE: O dicionário será atualizado de forma a não alterar o tratamento atual do sistema.' )
