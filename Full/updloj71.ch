#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion de la FNC 00000023577/2010."
	...
	#define STR0004 "FNC 00000023577/2010"
	...
	#define STR0031 "Campo LG_TKTFACT ya registrado"
#else
	#ifdef ENGLISH
		#define STR0001 "This program adjusts data dictionaries due to FNC 00000023577/2010."
		...
		#define STR0031 "The field LG_TKTFACT is already registered."
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função da FNC 00000023577/2010.", "Este programa tem como objetivo ajustar os dicionários de dados em função do FNC 00000023577/2010." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Este procedimento deverá ser utilizado em modo exclusivo! ", "Esta rotina deve ser processada em modo exclusivo! " )
		...
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Fim Actualização Estruturas. ", "Fim Atualizando Estruturas " )
		...
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Campo LG_TKTFACT já registado", "Campo LG_TKTFACT jÁ cadastrado" )
	#endif
#endif
