	...
	#define STR0020 "Borrar"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Registo - SX1", "Registro - SINDEX" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Tradução SX1 - ENGLISH", "Tradução SX1 - INGLÊS" )
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Tradução SX1 - SPANISH", "Tradução SX1 - ESPANHOL" )
