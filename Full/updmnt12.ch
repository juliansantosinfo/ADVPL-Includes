	...
	#define STR0049 "Favor actualizar la tabla manualmente."
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Actualização do Dicionário de Dados -> UPDMNT12", "Atualização do Dicionário de Dados -> UPDMNT12" )
		...
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "  pode ser utilizada por outras estações.", "  podendo estar em uso por outras estações." )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Actualização do Dicionário -> UPDMNT12", "Atualização do Dicionário -> UPDMNT12" )
		...
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Actualização de dados", "Atualizacao de Dados" )
		#define STR0021 "Empresa "
		...
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Actualização de gatilhos no SX7 ", "Atualizacao de gatilhos no SX7 " )
		...
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "Não foi possível abrir Sigamat.Emp em modo exclusivo.", "Nao foi possivel Abrir Sigamat.Emp em Modo Exclusivo" )
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Verifique se existem utilizadores no sistema.", "Verifique se existem usuarios no sistema." )
		#define STR0040 If( cPaisLoc $ "ANG|PTG", "Registo SIGAMAT.EMP não encontrado!", "Arquivo SIGAMAT.EMP nao encontrado!" )
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Actualização das Tabelas:", "Atualizacao das Tabelas:" )
		#define STR0042 "- Tabela "
		#define STR0043 If( cPaisLoc $ "ANG|PTG", " Não necessita de actualização.", " não necessita de atualização" )
		...
		#define STR0048 If( cPaisLoc $ "ANG|PTG", "Não foi possível actualizar na base de dados tabela ", "Não foi possível atualizar no banco de dados tabela " )
