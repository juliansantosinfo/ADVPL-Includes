	...
	#define STR0015 "Vigencia en el archivo de las Operadoras del Prestador"
	#define STR0016 "Esta rutina realizara la compatibilizacion de los diccionarios y de la base de datos,"
	#define STR0017 "ademas de los ajustes referentes a la siguiente FNC:"
	#define STR0018 "   FNC: "
	...
	#define STR0027 "¡Procesamiento concluido con exito!"
	...
	#define STR0045 "Marca/Desmarca"
		...
		#define STR0015 "Validity in register of Provider's Cooperatives"
		...
		#define STR0027 "Processing successfully completed!"
		#define STR0028 "SX3 -  Field Dictionary"
		#define STR0029 "Initial Effectiveness"
		#define STR0030 "Initial effective date"
		#define STR0031 "Enter initial effective date."
		#define STR0032 "Final Effectiveness"
		...
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Vigência no registo das Operadoras do Prestador", "Vigência no cadastro das Operadoras do Prestador" )
		...
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "e demais ajustes referente a FNC abaixo:", "e demais ajustes referente a fnc abaixo:" )
		#define STR0018 "   FNC: "
		#define STR0019 "   Referência: "
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Atenção: Efectuar o backup dos dicionários e do banco de dados previamente ", "Atenção: efetuar backup dos dicionários e do banco de dados previamente " )
		#define STR0021 "Compatibilizador"
		...
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Processamento concluído com sucesso!", "Processamento concluído com sucesso !" )
		#define STR0028 "SX3 - Dicionário de Campos"
		#define STR0029 "Vig. Inicial"
		#define STR0030 "Data de inicio da Vigência"
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Informar a data de início da vigência.", "Informar a data de inicio da vigência." )
		#define STR0032 "Vig. Final"
		...
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "Foram alteradas as estruturas das seguintes tabelas: ", "Foram alteradas as estruturas das seguintes tabelas : " )
		...
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Nao existem bancos a consultar", "Nao existe bancos a consultar" )
		#define STR0042 If( cPaisLoc $ "ANG|PTG", "Cód Empresa", "Cod Empresa" )
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "Cód Filial", "Cod Filial" )
		#define STR0044 "Empresa /Filial"
		#define STR0045 "Marca/Desmarca"
	#endif
#endif
