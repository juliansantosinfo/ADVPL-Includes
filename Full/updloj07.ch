	...
	#define STR0029 "Ok"
	#define STR0030 "Imprime Fact"
#else
	#ifdef ENGLISH
		#define STR0001 "The purpose of this program is to adjust the data dictionaries according to BOPS "
		...
		#define STR0029 "Ok"
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Imprime Fact.", "Imprime NF" )
	#endif
#endif
