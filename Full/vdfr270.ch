#ifdef SPANISH
	#define STR0001 'Plantilla de porcentaje de cargo en comision reservado para efectivos'
	...
	#define STR0005 'Ley n.º 9.782 del 19 de julio de 2012 (Articulo 14)'
#else
	#ifdef ENGLISH
		#define STR0001 'Percentage Board Position in Reserved Commission for Effectives'
		...
		#define STR0005 'Law no. 9,782 from July 19, 2012 (Article 14)'
	#else
		#define STR0001 'Quadro de Porcentagem de Cargo em Comissão Reservado Para Efetivos'
		...
		#define STR0004 'Servidores'
		#define STR0005 'Lei n.º 9.782 de 19 de julho de 2012 (Artigo 14)'
	#endif
#endif
