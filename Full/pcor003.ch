	...
	#define STR0008 "LISTA DEL ARCHIVO DE OPERACIONES PRESUPUESTARIAS"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Relação Do Registo De Operações Orcamentarias", "Relacao do Cadastro de Operacoes Orcamentarias" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Ira imprimir o registo de operações orcamentarias", "Ira imprimir o cadastro de operacoes orcamentarias" )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Relação Do Registo De Operações Orcamentarias", "RELACAO DO CADASTRO DE OPERACOES ORCAMENTARIAS" )
	#endif
#endif
