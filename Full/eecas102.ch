	...
	#define STR0013 "Atencion"
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "País", "Pais" )
		...
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "País do instrum.: ", "Pais do Instr.: " )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Ok", "ok" )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Cofacturairma eliminação ?", "Confirma Exclusão ?" )
