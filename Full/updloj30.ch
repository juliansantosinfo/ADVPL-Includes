	...
	#define STR0029 "ok "
		...
		#define STR0029 "OK "
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 25752008. ", "Este programa tem como objetivo ajustar os dicionários de dados em função da FNC 1818/2009. " )
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "A analisar o dicionário de dados...", "Analisando Dicionário de Dados..." )
		#define STR0014 "Fim - Dicionário de Dados"
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Início Actualização das Estruturas ", "Início Atualizando Estruturas " )
