	...
	#define STR0054 "La fecha Final debe ser igual a la Fecha Inicial del apuntamiento"
		...
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Troca médico de plantão", "Troca Médico de Plantão" )
		#define STR0008 "Troca"
		#define STR0009 "Falta"
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Cancela plantão", "Cancela Plantão" )
		#define STR0011 "Cancela"
		#define STR0012 "Setor não encontrado"
		#define STR0013 "Atenção"
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "Registo de plantao", "Cadastro de Plantão" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "O período final do plantao e anterior ao período inicial!", "O período final do plantão é anterior ao período inicial!" )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", "O médico não pode ser alterado, utilize a função de troca!", "O Médico não pode ser alterado, utilize a função de troca!" )
		#define STR0017 "Profissional não encontrado"
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "Profissional já está registado noutro plantão nesse período", "Profissional já está cadastrado em outro plantão nesse período" )
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "O período digitado já esta contém plado em escala anterior para esse medico!", "O período digitado já está contemplado em Escala anterior para esse Médico!" )
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "A data digitada está fora do período seleccionado para este sector.", "A data digitada está fora do período selecionado para este setor." )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "A data/hora final é anterior à data/hora inicial.", "A data/hora final é anterior a data/hora inicial." )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "A data final é anterior à data inicial da escala de plantão.", "A data final é anterior a data inicial da escala de plantão." )
		#define STR0023 "Hora inicial inválida."
		#define STR0024 If( cPaisLoc $ "ANG|PTG", "A data/hora digitada esta fora do período selecionado para esse setor.", "A Data/Hora digitada está fora do período selecionado para esse setor." )
		#define STR0025 "Hora final inválida."
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Existe escala de plantao registada para esse período!", "Existe escala de plantão cadastrada para esse período!" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Atenção", "Atencao" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Inclusão não permitida.", "Inclusao nao permitida." )
		...
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Troca inválida para plantao alterado/excluido. confirme ou cancele a operação anterior para activar essa função.", "Troca inválida para plantão alterado/excluído. Confirme ou cancele a operação anterior para habilitar essa função." )
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "Troca de plantao", "Troca de plantão" )
		#define STR0035 "Médico substituto"
		#define STR0036 "Motivo"
		#define STR0037 If( cPaisLoc $ "ANG|PTG", "Opção desactivada para esta escala de plantao.", "Opção desabilitada para esta escala de plantão." )
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "Falta/cancelamento inválido para plantao alterado/excluido. confirme ou cancele a operação anterior para activar essa função.", "Falta/Cancelamento inválido para plantão alterado/excluído. Confirme ou cancele a operação anterior para habilitar essa função." )
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Falta/cancelamento inválido para esta escala de plantão. Emissão de extrato do profissional já efectuada.", "Falta/Cancelamento inválido para esta escala de plantão. Emissão de extrato do profissional já efetuada." )
		#define STR0040 "Falta não pode ser apontada para esta escala de plantão."
		#define STR0041 "Cancelamento inválido para esta escala de plantão."
		#define STR0042 "Falta em plantão"
		#define STR0043 "Cancelamento de plantão"
		#define STR0044 "Troca inválida! Médico idêntico ao anterior."
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "Válida troca", "Valida troca" )
		#define STR0046 "Plantão médico"
		#define STR0047 "Médico inválido"
		#define STR0048 If( cPaisLoc $ "ANG|PTG", "Troca inválida para esta escala de plantão. Emissão de extrato do profissional já efectuada.", "Troca inválida para esta escala de plantão. Emissão de extrato do profissional já efetuada." )
		#define STR0049 If( cPaisLoc $ "ANG|PTG", "Existe escala de plantao registada para esse setor. impossivel exclui-lo!", "Existe escala de plantão cadastrada para esse setor. Impossivel exclui-lo!" )
		#define STR0050 "Exclusão não permitida"
		#define STR0051 If( cPaisLoc $ "ANG|PTG", "Existe despesa lançada para este profissional no período digitado. operação inválida!", "Existe despesa lançada para este profissional no período digitado. Operação inválida!" )
		#define STR0052 If( cPaisLoc $ "ANG|PTG", "Operação não permitida", "Operação nao permitida" )
