#ifdef SPANISH
	#define STR0001 "Update UPDCOM22"
	#define STR0002 "Actualizacion del tamano de los campos NIT"
	...
	#define STR0005 "La rutina de actualizacion ajustara el tamano de los campos NIT"
	#define STR0006 "Antes de iniciar la actualizacion, lea y acepte los siguientes terminos y condiciones. Despues de aceptarlos, continue con la actualizacion."
	#define STR0007 "ATENCION:"
	#define STR0008 "Este update tiene como objetivo ajustar en el diccionario de datos el tamano de los campos NIT"
	#define STR0009 " "
	...
	#define STR0056 "Atencion: Update exclusivo para el pais: Bolivia, Peru."
#else
	#ifdef ENGLISH
		#define STR0001 "Update UPDCOM22"
		#define STR0002 "Update of NIT field sizes"
		#define STR0003 "Handling adjustment of each table:"
		#define STR0004 "Attention: No user can be using system for adjustment to be made."
		#define STR0005 "The update routine will adjust NIT field sizes"
		...
		#define STR0008 "This update purports to adjust NIT field sizes in data dictionary"
		#define STR0009 " "
		...
		#define STR0056 "Attention: Exclusive update for country: Bolivia, Peru."
	#else
		#define STR0001 "Update UPDCOM22"
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Actualização do tamanho dos campos NIT", "Atualizacao do tamanho dos campos NIT" )
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "O procedimento de actualização ajustará o tamanho dos campos NIT", "A rotina de atualização irá ajustar o tamanho dos campos NIT" )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Este update tem como objectivo ajustar, no dicionário de dados, o tamanho dos campos NIT", "Este update tem como objetivo ajustar no dicionário de dados o tamanho dos campos NIT" )
		...
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "Atenção: Update exclusivo para o país: Bolívia, Peru.", "Atenção: Update exclusivo para o país: Bolivia, Peru." )
	#endif
#endif
