	...
	#define STR0022 "  Visto empleado        Visto Supervisor  |"
	#define STR0023 "|          A-INVENTARIO Num."
	#define STR0024 "|          B-INVENTARIO Num."
	#define STR0025 "|          C-INVENTARIO Num."
	#define STR0026 " Por Direccion     "
#else
	#ifdef ENGLISH
		#define STR0001 "Inventory Labels"
		#define STR0002 "This program will print labels for Physical Inventory."
		...
		#define STR0013 " Gr:"
		#define STR0014 " Um:"
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "| Descr.: ", "| Descri.: " )
		#define STR0016 "| Armaz:"
		#define STR0017 If( cPaisLoc $ "ANG|PTG", " Morada:", " Ender.:" )
