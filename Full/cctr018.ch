#ifdef SPANISH
	#define STR0001 "Este informe imprimira cronograma de proyecto(s)de acuerdo a parametros solicitados."
	#define STR0002 "Cronograma Fisico-Financiero Previsto de Proyecto"
...
#else
	#ifdef ENGLISH
		#define STR0001 "This report will print the project(s) chronogram(s) according to the requested parameters."
