	...
	#define STR0021 "consulte el CP"
		...
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "- rua (cobrança)", "- Logradouro (cobrança)" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "- número (cobrança)", "- Número (cobrança)" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "- Freguesia (cobrança)", "- Bairro (cobrança)" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "- código postal (cobrança)", "- CEP (cobrança)" )
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", ": : morada para cobrança : :", ": : Endereço Cobrança : :" )
