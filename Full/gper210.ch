	...
	#define STR0053 "El formato de este infome no permite la generacion del archivo en tabla. "
#else
	#ifdef ENGLISH
		...
		#define STR0053 "The format of this report does not allow generation of file in table."
	#else
		...
		#define STR0053 If( cPaisLoc $ "ANG|PTG", "O formato deste relatório não permite a geração do ficheiro em tabela.", "O formato deste relatório não permite a geração do arquivo em tabela." )
	#endif
#endif
