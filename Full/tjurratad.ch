	...
	#define STR0054 "Rutina de Prorrateo anulada por el usuario"
	#define STR0055 "¿Realmente desea anular la Rutina prorrateo?"
	#define STR0056 "Anular"
		...
		#define STR0051 "The increase value apportioned for the cases does not match with the increase value for the Contract: Code (Contr Cd:)"
		...
		#define STR0054 "Apportionment routine canceled by the user"
		#define STR0055 "Cancel Apportionment Routine?"
		...
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Acrésc.Contr.", "Acres Contr" )
		...
		#define STR0024 "Casos"
		#define STR0025 "Participantes"
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Cód.Contr.", "Cód Contr" )
		...
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Procedimento de rateio cancelada pelo utilizador", "Rotina de Rateio cancelada pelo usuário" )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", "Deseja realmente cancelar o procedimento Rateio?", "Deseja realmente cancelar a Rotina Rateio?" )
