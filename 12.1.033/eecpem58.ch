	...
	#define STR0023 "Emitir Facturas en (03) originales y (10) copias"
	...
	#define STR0041 "Otro"
	#define STR0042 "Arabica"
	#define STR0043 "Robusta"
	#define STR0044 "Torrado"
	#define STR0045 "Soluble"
	#define STR0046 "Otros"
	#define STR0047 "Via Seca (No Lavado)"
	#define STR0048 "Via Humeda (Lavado)"
	#define STR0049 "Descafeinado"
	#define STR0050 "Organico"
	#define STR0051 "Medio Transporte / Descripcion del Cafe"
	#define STR0052 "Transporte"
	#define STR0053 "Marca de IOC"
	#define STR0054 "Desc. Cafe"
	#define STR0055 "Metodo Proc."
	#define STR0056 "Unidad de Peso"
	#define STR0057 "Codigos"
	#define STR0058 "Exportador"
	#define STR0059 "Pais de Transbordo"
	#define STR0060 "Medio de Transporte"
	#define STR0061 "Puerto de Origen"
	#define STR0062 "Pais de Origen"
	#define STR0063 "Pais de Destino"
	#define STR0064 "Otras Informaciones"
	#define STR0065 "¡No se selecciono ningun Notify!"
	#define STR0066 "Atencion"
#else
	#ifdef ENGLISH
		#define STR0001 "N/Exportacion Nº."
		#define STR0002 "R.E. Nr."
		#define STR0003 "To"
		...
		#define STR0065 "No Notify was selected !"
		#define STR0066 "Warning"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "N/exportação Nº", "N/Exportacion Nº." )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Núm. R.e.", "Nro. R.E." )
		#define STR0003 "Para"
		#define STR0004 "Transportadora"
		#define STR0005 "Despachante"
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Núm. Fact", "Nro. Fact" )
		...
		#define STR0019 "Marks"
		#define STR0020 If( cPaisLoc $ "ANG|PTG", "Constar no corpo da", "Constar en el cuerpo de la" )
		#define STR0021 "Factura"
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Observações", "Observaciones" )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", "Emitir facturas em (03) originais e (10) cópias", "Emitir Facturas en (03) originales y (10) copias" )
		#define STR0024 "Atentamente,"
		#define STR0025 "Agente"
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Notifique", "Notify" )
		#define STR0027 "Tipo"
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Código", "Codigo" )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Descrição", "Descripcion" )
		#define STR0030 "Contactos"
		#define STR0031 "Agentes"
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "Observações", "Observaciones" )
		#define STR0033 "Contacto 1 "
		#define STR0034 "Contacto 2 "
		#define STR0035 "Contacto 3 "
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "Já existem dois agentes seleccionados !", "Ya existen dos agentes seleccionados !" )
		#define STR0037 "Aviso"
		#define STR0038 "Sacas"
		#define STR0039 "Granel"
		#define STR0040 If( cPaisLoc $ "ANG|PTG", "Contentores", "Containers" )
		#define STR0041 "Outro"
		#define STR0042 If( cPaisLoc $ "ANG|PTG", "Arábica", "Arabica" )
		#define STR0043 "Robusta"
		#define STR0044 "Torrado"
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "Solúvel", "Soluvel" )
		#define STR0046 "Outros"
		#define STR0047 If( cPaisLoc $ "ANG|PTG", "Via Seca (não Lavado)", "Via Seca (Nao Lavado)" )
		#define STR0048 If( cPaisLoc $ "ANG|PTG", "Via húmida (lavado)", "Via Umida (Lavado)" )
		#define STR0049 If( cPaisLoc $ "ANG|PTG", "Descafeínado", "Descafeinado" )
		#define STR0050 If( cPaisLoc $ "ANG|PTG", "Orgânico", "Organico" )
		#define STR0051 If( cPaisLoc $ "ANG|PTG", "Meio Transporte/descrição Do Café", "Meio Transporte/Descricao do Cafe" )
		#define STR0052 "Transporte"
		#define STR0053 If( cPaisLoc $ "ANG|PTG", "Marca Da Ioc", "Marca da IOC" )
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Desc. café", "Desc.Cafe" )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", "Método Proc.", "Metodo Proc." )
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "Unidade De Peso", "Unidade de Peso" )
		#define STR0057 If( cPaisLoc $ "ANG|PTG", "Código s", "Codigos" )
		#define STR0058 "Exportador"
		#define STR0059 If( cPaisLoc $ "ANG|PTG", "País De Transbordo", "Pais de Transbordo" )
		...
		#define STR0062 If( cPaisLoc $ "ANG|PTG", "País De Origem", "Pais de Origem" )
		#define STR0063 If( cPaisLoc $ "ANG|PTG", "País De Destino", "Pais de Destino" )
		#define STR0064 If( cPaisLoc $ "ANG|PTG", "Outros Dados", "Outras Informacoes" )
		#define STR0065 If( cPaisLoc $ "ANG|PTG", "Nenhuma notificação foi seleccionada !", "Nenhum Notify foi selecionado !" )
